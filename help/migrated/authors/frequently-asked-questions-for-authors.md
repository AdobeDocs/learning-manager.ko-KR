...
자세한 내용은  [Adobe Learning Manager: Adobe Captivate 9에서 모듈 게시](http://primehelp.adobe.com/kr/publish-modules-from-adobe-captivate9/)비디오 를 참조하십시오.
...
**관리자 지정** 해당 강의는 관리자만 지정할 수 있습니다. 학습자는 해당 유형의 강의에 등록할 수 없습니다.

**관리자 승인 필요** 해당 강의는 관리자의 승인을 받아야 합니다. 학습자는 해당 강의에 등록할 수 있지만 관리자의 승인 없이는 해당 유형의 강의에 직접 등록할 수 없습니다. 학습자가 이 유형의 강의에 참가하면 관리자에게 알림 요청이 전송됩니다. 관리자가 승인하면 학습자에게 해당 강의가 등록됨으로 목록화됩니다.
...
1. 모듈 유형을 다음과 같이 선택합니다. **공유됨** 모듈을 모든 작성자와 공유하려는 경우 공유하지 않으려면 비공개를 선택합니다.
...
**콘텐츠 모듈** 실제 강의 교육과정을 나타냅니다. 학습자는 해당 콘텐트를 살펴보고 강의의 전체 콘텐트를 더 잘 파악할 수 있습니다.
...
작성자는 다른 모듈에 드래그 앤 드롭하여 모듈의 순서를 변경할 수 있습니다. 또한 다음을 선택하여 학습자에게 모듈을 순서대로 수강하도록 강제할 수 있습니다. **순차** 강의 생성 중 모듈 시퀀스에서 옵션.

+++

+++필터링하여 특정 강의의 세트를 보려면 어떻게 해야 합니까?

강의를 필터링하려면 상태 옵션의 강의 필터를 사용합니다. 자세한 내용은 다음을 참조하세요.  [강의를 검색하려면 어떻게 해야 합니까?](https://helpx.adobe.com/content/help/en/captivate-prime/authors/frequently-asked-questions-for-authors.html#Course)
...
1. 필터를 사용하여 강의 목록을 필터링할 수 있습니다. 다음과 같은 상태별로 강의를 필터링할 수 있습니다 **모두, 게시됨, 초안** 및 **중단됨** 이 옵션을 각각 클릭합니다.
...
새로운 강의 또는 기존 초안 모듈에 강의 모듈을 추가할 수 있습니다. 새 강의에 모듈을 추가하려면 다음을 참조하십시오.  [강의를 생성하려면 어떻게 해야 합니까?](http://primehelp.adobe.com/questions/how-do-i-create-a-new-course/)
