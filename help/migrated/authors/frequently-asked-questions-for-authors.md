...
**관리자 지정:** 이 강의는 관리자만이 지정할 수 있습니다. 학습자는 해당 유형의 강의에 등록할 수 없습니다.

**관리자 승인 필요:** 이러한 강의에는 관리자의 승인이 필요합니다. 학습자는 해당 강의에 등록할 수 있지만 관리자의 승인 없이는 해당 유형의 강의에 직접 등록할 수 없습니다. 학습자가 이 유형의 강의에 참가하면 관리자에게 알림 요청이 전송됩니다. 관리자가 승인하면 학습자에게 해당 강의가 등록됨으로 목록화됩니다.
...
1. 삭제하고 싶은 강의 위로 마우스를 가져간 다음 &#39;강의 삭제&#39;를 클릭합니다.
...
1. 작성자로 로그인한 뒤 왼쪽 창의 &#39;모듈 라이브러리&#39;를 클릭합니다.
1. 페이지 오른쪽 상단 모서리에 있는 &#39;추가&#39;를 클릭합니다.
1. 모듈 이름, 설명, 모듈 태그를 채웁니다.
1. 모듈을 모든 작성자와 공유하려면 모듈 유형에 **공유됨**&#x200B;을 선택합니다. 공유하지 않으려면 비공개를 선택합니다.
...
+++테스트, 사전 작업 및 콘텐트 모듈이란 무엇입니까?

강의를 생성하는 작성자는 이러한 용어를 보게 될 수 있습니다.

**테스트 모듈**&#x200B;은 강의의 핵심 모듈을 나타냅니다. 학습자가 이 중요한 모듈을 완료하면 강의의 실제 내용을 완료하지 않아도 강의를 완료한 것으로 간주할 수 있습니다.

**콘텐츠 모듈**&#x200B;은 실제 강의 교육과정을 나타냅니다. 학습자는 해당 콘텐트를 살펴보고 강의의 전체 콘텐트를 더 잘 파악할 수 있습니다.

**사전 작업 모듈**&#x200B;은 학습자가 기본 사항을 파악하고 강의에 대해 준비할 수 있도록 지원합니다.
...
+++강의 모듈의 순서를 정할 수 있습니까? 어떻게 해야 합니까?
...
1. 필터를 사용하여 강의 목록을 필터링할 수 있습니다. **전체, 게시됨, 초안** 및 **중단됨** 등 각 옵션을 클릭하여 강의에 필터를 적용할 수 있습니다.
...
+++다른 작성자의 모듈을 내 강의에 추가할 수 있습니까? 어떻게 해야 합니까?
...
따라서 다른 작성자의 모듈 중 공유된 모듈만 귀하의 강의에 추가할 수 있습니다.
...
**모듈 라이브러리** > **추가**&#x200B;를 클릭하여 모듈 라이브러리에 모듈을 추가할 수 있습니다.
...
1. 시작 페이지에서 **[!UICONTROL 강의 생성]**&#x200B;을 클릭합니다.\
   기본 정보 페이지가 나타납니다.

1. 강의에 필요한 기본 정보를 제공합니다. 사용할 수 있는 정적 도움말에 있는 지침을 따르십시오.
1. 강의에 **[!UICONTROL 모듈 추가]**&#x200B;를 클릭하고 4개 모듈로 구성된 목록에서 모듈을 선택합니다. 각 모듈에 대해 필수 기본 정보를 제공한 다음 **[!UICONTROL 완료]**&#x200B;를 클릭합니다.

강의 생성을 완료한 후 &#39;저장&#39;을 클릭합니다. 강의는 기본적으로 초안으로 저장됩니다. 강의를 게시하려면 **[!UICONTROL 게시]**&#x200B;를 클릭합니다.

강의 게시를 준비하려면 강의 이름, 최소한 한 개의 모듈, 등록 유형, 역량, 역량 레벨, 점수를 추가해야 합니다.

다음 단계를 따라서 나열된 초안 강의를 게시할 수도 있습니다.
