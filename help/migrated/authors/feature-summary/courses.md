...
1. 변경 사항을 저장하려면 **[!UICONTROL 저장]**&#x200B;을 클릭합니다. 강의를 게시하려면 **[!UICONTROL 게시]**.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>모듈에 대한 시도 횟수를 무한으로 또는 지정된 횟수만큼 설정할 수 있습니다.<span style="font-size: 0.8125rem;">활성화되면 시도 정보가 학습자에게 표시됩니다. 학습자는 '재시도' 버튼을 클릭하여 모듈을 재시도하도록 선택할 수 있습니다.</span></p></td>
  </tr>
  <tr>
   <td>
...
* **게시됨** - 작성자가 강의 게시를 완료했을 때. 이 상태인 경우 학습자는 강의에 등록할 수 있습니다. 이 상태의 강의는 편집할 수도 있습니다.
...
작성자는 강의를 정렬하여 더 쉽게 필요한 강의를 찾을 수 있습니다. 다음을 수행합니다. **[!UICONTROL 정렬 기준]** 을 입력한 후, 알파벳 오름차순, 알파벳 내림차순, 강의 생성 날짜, 강의 업데이트 날짜 및 강의 효과를 선택합니다.
