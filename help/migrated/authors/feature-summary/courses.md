...
5. **강의 설정 수정**-
   ...
   a. 강의 설정 페이지에서 강의 스킬을 선택합니다. 스킬 드롭다운 목록에서 필요한 스킬을 선택합니다. 그런 다음 레벨 드롭다운 목록에서 필요한 레벨을 선택합니다.
   b. 강의 스킬, 레벨을 선택하고 스킬에 대한 점수를 설정합니다. 필요한 경우 더 많은 기술을 추가하세요.
...
5. 인스턴스의 속성을 입력합니다.
   ...
   * **시작 날짜:** 과정의 시작 날짜입니다. 두 개의 미리 알림 전자 메일은 선택된 두 개의 날짜에 이 시작 날짜 이전에 학습자에게 전송될 수 있습니다. 시작 날짜는 완료 날짜보다 이전 날짜여야 합니다. 시작 날짜를 선택하면 인스턴스의 **알림 경고** 섹션에 있는 달력에서 이 날짜가 파란색으로 강조 표시됩니다.
...
7. **[!UICONTROL 강사가 성공을 표시할 수 있도록 허용]** 옵션을 선택합니다.
   ...
   ![강사가 성공을 표시할 수 있도록 허용&quot; 확인란이 강조 표시되어 작성자가 모듈에 대한 학습자 성공 상태를 기록할 수 있도록 합니다](/help/migrated/authors/feature-summary/assets/allow-instructor-mark-success.png)
