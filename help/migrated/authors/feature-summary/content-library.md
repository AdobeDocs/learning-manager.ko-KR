...
>[!NOTE]
>
>**[!UICONTROL 중단]** 섹션에서 콘텐츠를 추가하고 **[!UICONTROL 콘텐츠 라이브러리]** > **[!UICONTROL 중단]**&#x200B;으로 이동한 다음 **[!UICONTROL 콘텐츠 추가]**&#x200B;를 선택할 수도 있습니다. 자세한 내용은 [정적 콘텐츠 추가](content-library.md#addstaticcontent)를 참조하십시오.
