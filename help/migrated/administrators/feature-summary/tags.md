...
1. 변경할 태그를 선택합니다. 최대 50개까지 태그를 선택할 수 있습니다. **[!UICONTROL 작업]** 드롭다운 메뉴를 열고 **[!UICONTROL 바꾸기]**&#x200B;를 선택합니다.
...
1. **[!UICONTROL 변경한 태그 이름]** 옵션에서 교체하길 원하는 태그를 선택하여 이름을 입력합니다. 드롭다운에서 기존 태그로 바꾸거나 새 태그를 추가할 수 있습니다.
   ...
   태그 이름에는 세미콜론 또는 쉼표를 넣을 수 없습니다.  이러한 태그를 일부 LO의 부분으로 사용하면 마이그레이션 시나리오에서 처리할 수 없습니다. 세미콜론 없는 태그나 오류 메세지를 확인하십시오.
...
1. 확장할 태그를 선택합니다. 최대 50개까지 태그를 선택할 수 있습니다. 작업 드롭다운 메뉴를 열고 **[!UICONTROL 추가]**&#x200B;를 선택합니다.
...
* 선택한 태그가 더 이상 유효하지 않다는 오류 메시지가 나타났을 때 사용자에게 새 태그를 생성할 권한이 없을 수 있습니다. 이 경우에 책임자는 관리자에게 문의하여 잘못된 태그를 수정할 수 있습니다.
