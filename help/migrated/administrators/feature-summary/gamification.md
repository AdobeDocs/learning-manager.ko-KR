...
학습자는 5가지 게임화 과제를 가지고 있으며 책임자가 포인트를 설정할 수 있습니다. 모든 학습자의 작업 및 포인트를 보여 주는 그림이 아래에 나와 있습니다.

>[!NOTE]
>
>특정 과제의 학습자를 위한 게임화 점수는 누적되지 않는다. 하지만 학습자가 여러 과제에서 해당 점수를 획득한 경우, 학습자 계정에는 점수가 누적됩니다.
...
내부 및 외부 사용자 모두에게 게임화 설정 재설정을 적용할 수 있습니다.
