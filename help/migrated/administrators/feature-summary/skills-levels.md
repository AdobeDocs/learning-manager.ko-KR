...
Adobe Learning Manager에서는 스킬 맵을 사용하여 스킬 세트에 근거한 학습자 성과를 매핑할 수 있습니다. 학습자는 강의를 완료하면 학습자 홈페이지에서 각 스킬 맵을 보고 내 순위를 알 수 있습니다.
...
관리자는 **스킬 추가** 대화 상자의 일괄 업로드 옵션을 사용하여 Adobe Learning Manager 내에서 직접 여러 스킬을 추가할 수 있습니다.

스킬을 일괄 추가하려면 다음을 수행합니다.

1. 왼쪽 창에서 **스킬**&#x200B;을 선택합니다.

1. **추가** > **스킬 추가**&#x200B;를 선택합니다. <br> **스킬 추가**&#x200B;의 팝업 창이 나타납니다.

1. **스킬 일괄 추가(CSV 업로드)**&#x200B;를 선택합니다.

   CSV 업로드 옵션을 사용하여 ![스킬 일괄 추가 대화 상자](assets/add-skills-bulk-upload-csv.png)
   *스킬을 대량으로 추가하는 옵션을 보여 주는 스킬 추가 팝업 창*

1. 스킬 세부 정보가 포함된 CSV 파일을 업로드합니다.
...
**[!UICONTROL 스킬]** 페이지에서 수정하려는 스킬을 클릭합니다. **[!UICONTROL 스킬 편집]** 대화 상자에서 필요한 사항을 변경합니다. 예를 들면 다음과 같습니다.
...
1. CSV를 업로드합니다. CSV의 열은 다음과 같습니다.
   ...
   * 강사 전자 메일 또는 강사 UUID
   ...
   UUID가 활성화된 계정의 경우 강사 전자 메일 열을 강사 UUID로 변경합니다.
...
+++강의 완료와 연결되도록 배지와 스킬을 활성화하려면 어떻게 해야 합니까?
