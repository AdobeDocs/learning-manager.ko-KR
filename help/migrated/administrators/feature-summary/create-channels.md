...
1. **상태** 섹션에서 다음 옵션을 구성합니다.
   ...
   1. **학습자에게 표시**: 학습자가 채널을 사용할 수 있게 하려면 이 옵션을 활성화합니다. 구성 또는 테스트를 계속하는 동안 채널을 숨기려면 이 옵션을 비활성화합니다.
      ...
      >[!NOTE]
      >
      >채널 탭은 이 설정이 활성화되어 있고 하나 이상의 비디오가 포함되어 있는 경우에만 학습자에게 표시됩니다.
...
1. (선택 사항) **고급 설정 표시**&#x200B;를 선택한 후 필요에 따라 다음 옵션을 구성합니다.
   ...
   1. **채널 테마 색상**: 드롭다운 목록에서 색상을 선택하여 채널의 시각적 모양을 사용자 지정합니다.

   1. **크롤링 깊이**: 비디오 콘텐츠를 검색할 연결된 페이지의 크롤링 깊이를 입력하십시오. 최대 크롤링 깊이 **2**&#x200B;을(를) 지원합니다.
...
1. 하나 이상의 채널 옆에 있는 확인란을 선택한 다음 **동작**&#x200B;을 선택합니다.
   ...
   ![하나 이상의 선택한 채널을 사용하지 않으려면 [동작] 메뉴에서 [사용 안 함]을 선택합니다.](assets/disable-channels.png)
...
1. **학습자에게 숨기기**&#x200B;를 선택합니다.<br> **학습자에게 숨기기** 팝업 창이 나타납니다.
   ...
   ![채널 구성을 삭제하지 않고 학습자에게 채널을 숨깁니다.](assets/hide-channels-from-learners.png)
