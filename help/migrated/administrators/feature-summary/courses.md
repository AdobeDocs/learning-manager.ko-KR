...
관리자는 기본 배지, 게임화 설정 및 알림 메시지를 **[!UICONTROL 기본 인스턴스]** 페이지. 기본 인스턴스 설정을 수정하려면 **[!UICONTROL 기본 인스턴스]** > **[!UICONTROL 편집]**.

* **[!UICONTROL 배지]**: 드롭다운 메뉴에서 기본 배지를 선택합니다.
* **[!UICONTROL 게임화]**: 완료, 조기 완료 및 적시 완료 점수를 포함한 게임화 설정을 구성합니다. 관리자에게는 계정 수준 설정을 선택하거나 이 인스턴스에 대한 게임화 지점을 사용자 정의할 수 있는 옵션이 있습니다.
* **[!UICONTROL L1 반응 피드백]**: 강의 완료 시 학습자 피드백에 미리 정의된 질문을 활성화합니다. 질문을 필수로 설정하는 옵션도 있습니다.
***[!UICONTROL L3 동작 변경 피드백]**: 강의 완료 시 학습자의 관리자에게 피드백 질문을 활성화할 수 있습니다.
***[!UICONTROL 미리 알림 설정]**: 에스컬레이션 옵션을 사용하여 마감일에 대한 미리 알림을 설정하고 관리합니다.
