...
>[!NOTE]
>
>이 기능(**L1 피드백 보고서**)은 FedRAMP 인증 환경에서 사용할 수 없습니다. 자세한 내용은 [FedRAMP 환경의 기능 가용성](/help/migrated/feature-availability-in-fedramp-authorized-environment.md)을 참조하세요.
...
6. **[!UICONTROL 질문 추가]** 메뉴에서 다음 중 질문 유형을 선택합니다.
   ...
   a. **[!UICONTROL 무료 텍스트]**: 학습자가 직접 작성한 단어로 답변을 제공할 수 있습니다.
   ...
   * 질문을 필수 항목으로 만들려면 **[!UICONTROL 필수]** 토글을 선택합니다.
   ...
   b. **[!UICONTROL 숫자 크기 조절/NPS]**: 학습자는 숫자 크기 조절(일반적으로 1~10)을 사용하여 강의 만족도 또는 강의를 추천할 가능성을 평가할 수 있습니다.
   ...
   * 질문을 필수 항목으로 만들려면 **[!UICONTROL 필수]** 토글을 선택합니다.
   ...
   c. **[!UICONTROL 리커트 척도]**: 학습자는 설명에 동의하는 정도를 지정할 수 있습니다(강력하게 동의하지 않음 - 강력하게 동의).
