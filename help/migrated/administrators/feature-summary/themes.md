...
**[!UICONTROL 새 로고 업로드]**&#x200B;를 클릭한 다음 컴퓨터에서 업로드할 로고를 선택합니다. 아래에서 로고의 모양 및 조직 이름을 미리 보기할 수 있습니다. 원하는 헤더 스타일을 선택한 다음 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
...
이 섹션 아래에 있는 **[!UICONTROL 힌트 표시]**&#x200B;를 클릭하여 아래 이미지에 표시된 것처럼 힌트를 표시합니다.
...
테마 섹션의 왼쪽 하단 모서리에 있는 **[!UICONTROL 실시간 미리 보기]**&#x200B;를 클릭합니다. 아래와 같이 팝업 창이 나타납니다.

![](assets/live-theme-preview.png)

*실시간 미리 보기 팝업*

드롭다운 목록에서 원하는 테마를 선택한 다음 설정을 조절합니다. 응용 프로그램에서 실시간으로 변경 사항을 보려면 **[!UICONTROL 미리 보기]**&#x200B;를 클릭합니다. 이제 응용 프로그램의 기능을 전부 살펴보고 변경 사항을 확인할 수 있습니다. 또한 실시간 미리 보기를 하며 역할을 변경할 수 있습니다. 변경 사항에 만족한다면 실시간 테마 미리 보기 팝업 기능으로 돌아와 **[!UICONTROL 테마 적용]**&#x200B;을 클릭합니다.
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>파비콘</p></td>
   <td>
    <p>관리자는 Adobe Learning Manager 계정에 대한 파비콘을 변경할 수 없습니다. 파비콘을 업데이트하려면 지원팀(<a href="mailto:learningmanagersupport@adobe.com">learningmanagersupport@adobe.com</a>)에 문의하십시오. </p>
    <p>학습자의 배경에 적용해야 하는 이미지를 가지고 있어야 합니다.</p>
    <ul>
     <li><b>권장 이미지 형식:</b>PNG</li>
     <li><b>권장 크기: </b>32x32px</li>
    </ul></td>
  </tr>
 </tbody>
</table>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>몰입형 경험에 대해서만 적용됩니다. <strong>예</strong> 또는 <strong>아니요</strong>를 선택합니다. </p></td>
  </tr>
 </tbody>
</table>
