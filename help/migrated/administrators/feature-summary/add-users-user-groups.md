...
또는 사용자에 대한 작업자 또는 책임자 액세스를 제거할 수도 있습니다. 한 명 이상의 학습자를 선택하고 **[!UICONTROL 작업]**&#x200B;을 클릭한 다음 **[!UICONTROL 역할 제거]**&#x200B;를 선택합니다. 다음과 같은 옵션을 선택합니다. **[!UICONTROL 작성자 제거]**, 해당 학습자에 대한 작성자 액세스 권한이 해지됩니다.
...
사용자 목록에서 사용자를 선택한 다음 선택한 사용자를 클릭합니다. 사용자 세부 정보에서 **[!UICONTROL 편집]** ( ![](assets/edit-pen.png)) 버튼을 클릭합니다. **[!UICONTROL 사용자 편집]** 대화 상자에서 필요한 편집을 수행하고 변경 사항을 저장하려면 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
...
페이지 오른쪽 상단 모서리에서 **[!UICONTROL 추가]**&#x200B;를 클릭하고 **[!UICONTROL 자가 등록]**&#x200B;을 선택합니다.
...
1. **[!UICONTROL 외부 등록 프로필 추가]** 대화 상자에서 다음 세부 정보를 추가합니다.
   ...
   * (으)로 **[!UICONTROL 고급 설정]** 섹션에서 다음을 입력합니다.
      ...
      * **[!UICONTROL 로그인 요구 사항]:** 일 단위로 값을 지정합니다. 위 기간 동안 로그인하지 않는 학습자는 삭제됩니다.
...
언제든지 외부 파트너의 일시 중지된 상태를 취소하고 일반 서비스를 다시 시작할 수 있습니다. 외부 사용자 그룹을 일시 정지하려면 페이지 오른쪽 상단 모서리에서 **[!UICONTROL 작업]**&#x200B;을 클릭한 다음 **[!UICONTROL 다시 시작]**&#x200B;을 선택합니다.
...
사용자를 다른 외부 프로필로 이동하려면 오른쪽 상단에서 사용자를 선택하고 **[!UICONTROL 액션]** > **[!UICONTROL 프로필 변경]**. 프로필 목록에서 프로필을 선택한 다음 **[!UICONTROL 변경]**&#x200B;을 클릭합니다.

## 역할 할당 {#Assignarole-1}

사용자를 선택하고 오른쪽 상단에서 **[!UICONTROL 액션]** > **[!UICONTROL 역할 할당]** > **만들기`<role>`**. 사용자에게 새 역할이 할당됩니다.

## 역할 제거 {#Removearole-1}

사용자를 선택하고 오른쪽 상단에서 **[!UICONTROL 액션]** > **[!UICONTROL 역할 제거]** > **제거`<role>`**. 선택한 역할이 사용자에게 할당되었던 역할 목록에서 제거됩니다.
...
사용자 정보에 추가할 필드를 추가한 다음 **[!UICONTROL 저장]**&#x200B;을 클릭합니다. 필드를 추가한 후 **[!UICONTROL 사용자 편집]** 대화 상자.
...
여기에서는 책임자가 일괄 가져오기 기능을 사용하여 추가한 사용자들에 대한 CSV 가져오기 기록을 볼 수 있습니다. 다음을 클릭할 수도 있습니다. **추가** CSV 업로드 기능을 사용하여 사용자를 추가할 수 있습니다.
...
**[!UICONTROL 사용자 편집]** 대화 상자에서 필드를 적절하게 업데이트합니다. 변경 사항을 저장하려면 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
...
1. 다음을 수행합니다. **[!UICONTROL 사용자]** > **[!UICONTROL 활성 필드]**.
1. **[!UICONTROL 필드 구성]** 섹션에서 **[!UICONTROL 값 수정]**&#x200B;을 클릭합니다.
