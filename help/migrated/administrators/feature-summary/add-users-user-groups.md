...
1. 단일 사용자를 추가하려면 오른쪽 상단 모서리에서 **[!UICONTROL 추가]**&#x200B;를 클릭하고 **단일 사용자** 옵션을 선택합니다.
...
언제든지 외부 파트너의 일시 중지된 상태를 취소하고 일반 서비스를 다시 시작할 수 있습니다. 다음을 수행합니다. **[!UICONTROL 액션]** 페이지의 오른쪽 상단 모서리에서 **[!UICONTROL 다시 시작]**.
...
다음을 수행합니다. **[!UICONTROL 활성 필드]** 사용자 페이지 내에서 사용 가능. 학습자는 사용자 정의 값에 제공된 값 중에서만 선택할 수 있습니다.
...
여기에서는 책임자가 일괄 가져오기 기능을 사용하여 추가한 사용자들에 대한 CSV 가져오기 기록을 볼 수 있습니다. 다음을 클릭할 수도 있습니다. **[!UICONTROL 추가]** CSV 업로드 기능을 사용하여 사용자를 추가할 수 있습니다.
