...
보고서는 대시보드에 집계됩니다. 보고서는 대시보드 내에 있어야 합니다. 보고서 페이지에는 기본적으로 **[!UICONTROL 기본 대시보드]**&#x200B;가 있습니다. 사용자가 추가한 모든 보고서는 기본 대시보드로 이동합니다. 개별 대시보드에 보고서를 추가하려면 드롭다운 화살표를 사용하여 **[!UICONTROL 보고서 추가]**&#x200B;를 선택합니다. 대시보드 작성에 대한 자세한 내용은 이 페이지에 있는 대시보드 섹션을 참조하십시오.

## 보고서 유형 {#typesofreports}

Adobe Learning Manager에서는 완료, 사용 시간, 스킬 및 효과와 같은 주요 4가지 유형의 보고서를 지원합니다. 다음 보고서 유형을 사용하여 300개 이상의 다양한 보고서를 생성할 수 있습니다.
...
사용자 활동 대시보드는 계정에서 사용자 활동을 표시합니다. 나열된 세 개의 보고서는 다음과 같습니다.
...
>[!INFO]
>
>이 교육에서는 데이터베이스에서 대시보드 보고서를 생성하는 방법을 배웁니다.<br><br>[![단추](assets/launch-training-button.png)](https://content.adobelearningmanageracademy.com/app/learner?accountId=98632#/course/8318854)</br></br>


교육을 시작할 수 없는 경우 <almacademy@adobe.com>에 작성하세요.

플랫폼에서 모든 학습 활동의 요약 보고서를 확인합니다. 이 페이지에서는 선택한 루트 사용자의 팀 및 외부 프로필에 대한 다음과 같은 요약 정보를 확인할 수 있습니다. 시간 범위도 선택할 수 있습니다.
...
내부 루트 레벨 관리자가 있는 경우 차례로 표시됩니다.

모든 외부 프로필은 내부 프로필(내부 루트 레벨 사용자) 다음에 나열됩니다.

외부 프로필에 관리자가 있으면 **[!UICONTROL 다음에 대한 데이터 표시]** 드롭다운 목록에 관리자 계층이 표시됩니다. 사용자는 모든 세부 정보 페이지의 관리자 계층에 나열됩니다(학습 요약, 준수 및 스킬 상태).

그렇지 않다면 모든 개별 사용자 세부 정보가 목록에 표시됩니다.

다양한 내부 팀의 등록에 대한 자세한 세부 정보를 확인하려면 **[!UICONTROL 학습 요약 세부 정보]**&#x200B;를 클릭하십시오.

![](assets/learning-sunnarydetails.png)
*학습 요약 세부 정보*

등록을 클릭하면 각 관리자에 대한 학습자 및 등록한 학습 객체를 확인할 수 있습니다. 각 학습자의 진행 및 완료 세부 정보를 확인할 수도 있습니다.
...
또한 진행 중이고 달성된 스킬의 막대 차트 보기를 확인할 수 있습니다. 그래프에 포함하려는 스킬을 추가/제거할 수 있습니다.
...
대시보드는 보고서의 집합입니다. 원하는 대로 대시보드에서 보고서를 묶을 수 있습니다. 작성한 모든 보드를 보려면 보드 탭을 클릭합니다. **[!UICONTROL 대시보드 보기]** 드롭다운 목록에서 기본 보드나 내가 생성한 대시보드를 선택할 수 있습니다.
...
>[!INFO]
>
>이 교육에서는 과정 보고서를 내보내고 이러한 보고서에 대한 전자 메일 구독을 설정하는 방법에 대해 알아봅니다.<br><br>[![단추](assets/launch-training-button.png)](https://content.adobelearningmanageracademy.com/app/learner?accountId=98632#/course/8318904)</br></br>
...
자세한 내용은 [학습자 성적 증명서](/help/migrated/administrators/feature-summary/reports/learner-transcripts.md)를 참조하십시오.
...
**[!UICONTROL 콘텐츠 감사 내역]** 보고서 생성기를 사용하면 시스템 수명 동안 강의에 적용된 모든 변경 사항 및 편집에 대한 보고서를 생성할 수 있습니다. 생성된 보고서에는 다음과 같은 정보가 포함되어 있습니다.
...
사용자 감사 내역에서는 사용자, 사용자 그룹 및 자체 등록 프로필의 수명 주기를 확인할 수 있습니다. 사용자 추가, 삭제, 관리자 변경 등 모든 것이 캡처됩니다. 자체 등록 프로필 생성 및 삭제가 기록됩니다. 또한, 자체 등록 일시 중지 및 재시작도 할 수 있습니다.

자체 등록 추가, 삭제, 일시 중지 또는 재시작을 하는 동안 외부 프로필 추가, 활성화, 비활성화, 일시 중지 또는 재시작이 가능합니다. CSV 업로드도 확인 가능합니다.

1. **[!UICONTROL 보고서 > Excel 보고서 > 사용자 추적]**&#x200B;을 선택합니다. 사용자 감사 내역 대화 상자가 나타납니다.
...
1. &#39;보고서&#39; > &#39;Excel 보고서&#39; > &#39;게임화 보고서&#39;를 선택합니다.
...
1. 보고서를 생성하려면 **[!UICONTROL 생성]**&#x200B;을 클릭하십시오.
   ...
   학습자 보고서를 생성한 후 계정의 모든 사용자(내부, 외부 또는 삭제)에 대한 현재의 레벨 달성 정보를 내보낼 수 있습니다. 학습자의 레벨 달성 날짜를 확인할 수도 있습니다.
   ...
   * 플래티넘 달성 날짜
   ...
   이 열에는 레벨을 처음으로 달성한 날짜가 포함되어 있습니다. **[!UICONTROL 현재 레벨]** 열에는 학습자의 현재 레벨이 표시됩니다.
...
책임자와 관리자는 등록/미등록 학습자의 보고서를 추출할 수 있습니다. 책임자는 강의 인스턴스, 학습 프로그램, 인증에서 등록/미등록 학습자, 책임자 또는 관리자를 확인하고 보고서를 내보낼 수 있습니다. 반면에 관리자는 팀원 보고서만 가져올 수 있습니다. 관리자는 삭제된 학습자 또는 본인 이름을 등록/미등록 학습자로 관리자 응용 프로그램에서 볼 수 없습니다.
...
자세한 내용은 [피드백 보고서](/help/migrated/administrators/feature-summary/reports/feedback-report.md)를 참조하세요.
...
필터를 선택하고 다운로드를 클릭한 후 CSV 형식으로 보고서를 다운로드한다는 알림을 받게 됩니다.
...
![강사 활용 보고서 다운로드](assets/utilization-report.png)
*강사 활용률 보고서 다운로드*
...
>[!INFO]
>
>이 교육에서는 대시보드 보고서에 대한 전자 메일 구독을 설정하는 방법에 대해 알아봅니다.<br><br>[![단추](assets/launch-training-button.png)](https://content.adobelearningmanageracademy.com/app/learner?accountId=98632#/course/8318927)</br></br>
...
드롭다운 목록에서 보고서 이름을 선택하고 보고서 영역에 보고서 이름을 입력합니다. 드롭다운에서 전자 메일 빈도를 선택합니다. 전자 메일 주제를 추가하고 대체 전자 메일 ID를 입력합니다.
...
보드에 보고서를 추가하려면 보드 창의 오른쪽 위에 있는 드롭다운을 클릭한 다음 **[!UICONTROL 보고서 추가]**&#x200B;를 클릭합니다. 이 방식으로 생성된 보고서는 대시보드와 연결됩니다.
...
다음과 같은 두 가지 방법으로 보드를 공유할 수 있습니다.

* **[!UICONTROL 공유 대상]** 영역에 대시보드를 공유할 사용자를 입력합니다.
...
1. 보고서 생성을 완료하려면 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
...
선택한 보고서 유형에 따라 필터는 맨 아래에 있는 **[!UICONTROL &#39;추가&#39;]** 보고서 대화 상자에 나타납니다. 몇 가지 중요한 필터에 대한 설명이 아래에 있습니다.
...
**강의** 드롭다운에서 보고서를 선택하면 모든 강의에 따라 필터링할 수 있습니다.
...
X축에서 사용자 특성 옵션을 선택하고 옆에 있는 **선택** 드롭다운에서 특성을 선택합니다. 이러한 속성을 기반으로 사용자 정의 사용자 그룹 보고서를 생성하려면 필터에서 적절한 사용자 그룹도 선택해야 합니다.
...
**[!UICONTROL 복사본 생성]** 보고서를 대시보드 목록에서 선택한 다른 대시보드로 복사할 수 있습니다.

**[!UICONTROL 삭제]** 보고서를 제거하려면 &#39;삭제&#39;를 클릭합니다. 보고서를 삭제하기 전에 경고/확인 메시지가 나타납니다.

**[!UICONTROL 크기 조정]** 보고서 크기를 1×1 및 2×2 크기로 조정할 수 있습니다.
