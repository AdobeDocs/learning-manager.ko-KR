...
관리자는 학습자에게 이벤트 또는 활동 안내 공지를 보낼 수 있습니다. 공지는 텍스트, 이미지 또는 비디오로 구성될 수 있습니다. 강의, 학습 프로그램 및 인증과 같은 학습 객체를 공지사항에 연결할 수 있습니다.
...
멀티미디어 첨부 파일이 큰 경우에는 업로드하는 데 시간이 걸릴 수 있습니다. &#39;저장&#39;을 클릭하면 업로드가 완료될 때 메시지가 포함된 팝업이 나타납니다. 첨부 파일이 성공적으로 업로드되면 알림이 표시됩니다.
...
관리자 로그인에서는 모든 공지사항을 초안, 예약 및 전송과 같은 세 가지 탭으로 볼 수 있습니다.

<!--![](assets/three-tabs-announcement1.png)-->

### 초안 {#draft}

초안 탭에서는 관리자가 작성했지만 아직 발신하지 않았거나 전송이 예약되지 않은 모든 공지사항을 볼 수 있습니다.
