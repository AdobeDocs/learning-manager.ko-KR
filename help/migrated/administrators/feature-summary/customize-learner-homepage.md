...
&#39;몰입형&#39; 경험을 선택하면 이 옵션이 활성화되고 흐려집니다. 이 확인란은 &#39;클래식&#39; 경험에 대해서만 활성화됩니다.

![](assets/option-immersive.png)

*학습자 홈페이지 설정*

몰입형 레이아웃은 모든 신규 계정의 기본값입니다. 레이아웃은 책임자가 활성화하거나 비활성화할 수 있는 위젯으로 제어됩니다. 위젯의 위치 지정 방식을 기반으로 동일한 사항이 학습자 홈페이지에 반영됩니다.

다음은 활성화/비활성화할 수 있는 위젯입니다.
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <p>학습자에게 환영 배너입니다. 배너는 이미지나 비디오가 될 수 있습니다. 발행인란을 특정 사용자 그룹으로 대상을 지정할 수 있으며 학습자는 홈페이지에 도달하자마자 발행인란을 볼 수 있습니다. 사용자 그룹은 책임자가 설정한 대상 플랜에 따라 여러 히어로 이미지나 비디오를 볼 수 있습니다. </p>
  ...
  <tr>
   <td>
    <p>내 학습</p></td>
   <td>
    <p>최근에 학습자가 방문한 학습 개체를 보여줍니다. </p></td>
  </tr>
  <tr>
   <td>
    <p>달력</p></td>
  ...
  <tr>
   <td>
    <p>소셜 학습</p></td>
   <td>
    <p>학습자와 동일한 사용자 범위에 있는 사용자별 활동 및 게시물을 나열합니다. </p></td>
  </tr>
  <tr>
   <td>
    <p>조직에서 추천함</p></td>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>몰입형 경험에 대해서만 적용됩니다. <b>예</b> 또는 <b>아니요</b>를 선택합니다. <br></p></td>
  </tr>
 </tbody>
</table>
