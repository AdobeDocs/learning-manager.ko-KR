...
책임자 프로필 설정을 변경하고 계정 설정을 업데이트할 수 있습니다. 프로필 정보를 보고 프로필 사진을 추가/변경하며 **[!UICONTROL 내 정보]** 콘텐츠를 수정하세요. 회사 정보를 업데이트하고 사용자에 대한 로그인 방법을 설정하며 계정 설정을 통해 연결 통합을 설정합니다.
...
조직의 계정 설정을 업데이트하려면 왼쪽 창에서 설정을&#x200B;]**클릭합니다**[!UICONTROL .

**기본 정보 (회사 정보)**

페이지에서 변경을&#x200B;]**클릭하고**[!UICONTROL &#x200B;국가, 시간대, 로케일 및 회계 연도 설정을 편집합니다.

**책임자에게 문의 구성**

조직 지원 관리자 전자 메일 주소를 추가하거나 변경하려면 왼쪽 창에서 **[!UICONTROL &#39;일반&#39;]**&#x200B;을 클릭하여 구성할 수 있습니다. 지원 전자 메일 ID ]**옆의**[!UICONTROL &#x200B;변경을&#x200B;]**클릭하고**[!UICONTROL &#x200B;전자 메일 ID를 추가합니다. 학습자가 페이지 하단에 있는 &#39;관리자에게&#x200B;]**문의&#39;를 클릭하면**[!UICONTROL &#x200B;해당 관리자에게 전자 메일이 전송됩니다.

세미콜론을 구분 기호로 사용하여 이메일 ID를 추가합니다.

**로그인 방법** - 관리자는 내부 또는 외부 사용자가 계정에 액세스할 수 있는 모드를 선택할 수 있습니다.

* **내부 사용자:** 내부 사용자의 경우 Adobe ID 또는 Single Sign-On을 로그인 모드로 설정할 수 있습니다.
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li><b>재설정</b> 아이콘을 클릭하여 <b>도움말</b> 및 <b>관리자에게 문의</b> 필드의 기본값을 재설정합니다.</li>
  ...
  <tr>
   ...
   <td>
    ...
    <p><b>참고: </b>릴리스 직후 기본적으로 학습자 성적 증명서에서 변경은 예상되지 않습니다. 책임자는 책임자 &gt; 설정 &gt; 일반 &gt; 시간대 보고에서 이 설정을 구성할 수 있습니다.</p></td>
  </tr>
 </tbody>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="1709">
 <tbody>
  ...
  <tr>
   <td height="20">참고: 형식 및 기간 필터는 기본적으로 꺼져 있으며 릴리스 직후에 학습자에게 표시되지 않습니다. 책임자는 이를 활성화해야 합니다. </td>
  </tr>
  <tr>
  ...
  <tr>
   <td height="19">재설정 아이콘을 클릭하여 도움말 및 연락처 관리자 필드의 기본값을 재설정합니다.</td>
  </tr>
  <tr>
   <td height="20">모든 언어에 대해 바닥글의 링크를 사용자 정의할 수 있습니다. 언어 드롭다운 목록을 클릭하고 언어를 선택한 다음 지정된 필드에 이름과 URL을 추가합니다. 변경 사항을 저장하면 업데이트된 링크가 바닥글에 표시됩니다.</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>
    ...
    <p>이 기능은 강의에서만 사용할 수 있습니다. 학습 프로그램이나 인증에서 평가 등급은 지원되지 않습니다.<br><br><b>참고: </b>이 변경 사항은 학습자 앱에만 영향을 줍니다. </p>
    <p>다른 모든 앱(책임자, 작성자, 관리자, 사용자 정의 책임자, 사용자 정의 작성자)에서는 설정에서의 변경(평가 등급/강의 효과/등급 표시 비활성화)이 영향을 미치지 않습니다. </p>
    <p>새 계정의 경우 <b>등급</b> 표시 섹션에는 기본적으로 별 등급</b> 옵션이 <b>활성화되어 있습니다.</p>
    <p>기존 계정의 경우 이전에 계정에 코스 효율성</b> 옵션이 <b>활성화되어 있었다면 <b>코스 효율성 옵션이 선택된 상태에서 등급</b> 표시 섹션이 활성화됩니다. Course effectivenes</b>s 옵션이 <b>비활성화<b>되면 등급</b> 표시 섹션도 비활성화됩니다. <b>등급</b> 표시 섹션이 활성화되면 기본적으로 별 등급</b> 옵션이 <b>활성화됩니다.</p></td>
  </tr>
  <tr>
   <td height="19">중단</td>
   <td>다음 중 사용 중지 옵션을 선택합니다.<li>지원이 중단되면 등록된 학습자는 작업을 보고 수행할 수 있지만 아직 등록되지 않은 학습자는 액세스 권한을 잃게 됩니다.</li><li>지원이 중지되면 등록된 학습자와 아직 등록되지 않은 학습자 모두 액세스 권한을 잃게 됩니다.</li><div><b>참고:</b> 개요 페이지에서 강의, 학습 경로 또는 인증을 취소할 수 있습니다.</div> </td>
  </tr>
 </tbody>
</table>
...
1. 내 사진/계정 옆에 있는 오른쪽 상단 모서리에서 드롭다운 화살표를 클릭하고 **[!UICONTROL 프로필 설정]**&#x200B;을 선택합니다.
1. 팝업 대화창의 프로필 사진 영역에서 마우스를 움직이거나 **[!UICONTROL 편집]**&#x200B;을 클릭하여 사진을 추가/변경할 수 있습니다.
1. **[!UICONTROL 편집]**&#x200B;을 클릭하여 **[!UICONTROL 정보]** 콘텐츠를 추가/수정합니다.
...
* 관리자는 맞춤형 관리자에 대한 역할 정의의 일부로 폴더에 대한 액세스 권한을 제어할 수 있습니다.
...
폴더를 삭제할 수도 있습니다. 삭제할 폴더를 선택하고, [작업] 메뉴를 클릭하고, **[!UICONTROL 폴더 삭제]**&#x200B;를 클릭하십시오.
...
[설정] > **[!UICONTROL [기본 정보]**]에서 **[!UICONTROL [변경]**]을 클릭합니다&#x200B;**[!UICONTROL .]** **[!UICONTROL 회계 연도 시작]** 위치 드롭다운 목록에서 월을 선택합니다.
+++
