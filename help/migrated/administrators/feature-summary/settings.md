...
조직 지원 관리자 전자 메일 주소를 추가하거나 변경하려면 왼쪽 창에서 **[!UICONTROL &#39;일반&#39;]**&#x200B;을 클릭하여 구성할 수 있습니다. **[!UICONTROL 지원 전자 메일 ID]** 근처에 있는 **[!UICONTROL 변경]**&#x200B;을 클릭하고 전자 메일 ID를 추가합니다. 학습자가 페이지 바닥글에 있는 **[!UICONTROL 관리자 문의]**&#x200B;를 클릭하면 관리자에게 전자 메일이 전송됩니다.
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <p>이 기능은 강의에서만 사용할 수 있습니다. 학습 프로그램이나 인증에서 평가 등급은 지원되지 않습니다.<br><br><b>참고: </b>이 변경 내용은 학습자 앱에만 영향을 줍니다. </p>
    <p>다른 모든 앱(책임자, 작성자, 관리자, 사용자 정의 책임자, 사용자 정의 작성자)에서는 설정에서의 변경(평가 등급/강의 효과/등급 표시 비활성화)이 영향을 미치지 않습니다. </p>
    <p>새 계정의 경우 <b>등급 표시</b> 섹션에 기본적으로 <b>평가 등급</b> 옵션이 활성화됩니다.</p>
    <p>기존 계정의 경우 계정에 <b>강의 효과</b> 옵션이 이전에 활성화되었다면 <b>등급 표시</b> 섹션은 강의 효과 옵션이 선택된 상태로 활성화됩니다. <b>강의 효과</b> 옵션이 비활성화되면 <b>등급 표시</b> 섹션도 비활성화됩니다. <b>등급 표시</b> 섹션이 활성화되면 <b>평가 등급</b> 옵션이 기본적으로 활성화됩니다.</p></td>
  </tr>
  <tr>
   <td height="19">중단</td>
