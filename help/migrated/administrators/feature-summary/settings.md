...
책임자 프로필 설정을 변경하고 계정 설정을 업데이트할 수 있습니다. 내 프로필 정보를 보고 프로필 사진을 추가/변경하며 **[!UICONTROL 내 정보]** 내용을 수정합니다. 회사 정보를 업데이트하고 사용자에 대한 로그인 방법을 설정하며 계정 설정을 통해 연결 통합을 설정합니다.
...
[![단추](assets/launch-training-button.png)](https://content.adobelearningmanageracademy.com/app/learner?accountId=98632#/course/7476018)
...
조직 계정 설정을 업데이트하려면 왼쪽 창에서 **[!UICONTROL 설정]**&#x200B;을 클릭하세요.

**기본 정보(회사 정보)**

페이지에서 **[!UICONTROL 변경]**&#x200B;을 클릭하고 국가, 시간대, 지역 및 회계 연도 설정을 편집합니다.

**책임자에게 문의 구성**

조직 지원 관리자 전자 메일 주소를 추가하거나 변경하려면 왼쪽 창에서 **[!UICONTROL &#39;일반&#39;]**&#x200B;을 클릭하여 구성할 수 있습니다. **[!UICONTROL 지원 전자 메일 ID]** 근처에 있는 **[!UICONTROL 변경]**&#x200B;을 클릭하고 전자 메일 ID를 추가합니다. 학습자가 페이지 바닥글에 있는 **[!UICONTROL &#39;책임자에게 문의&#39;]**&#x200B;를 클릭하면 책임자에게 전자 메일이 전송됩니다.

세미콜론이 있는 전자 메일 ID를 구분 기호로 추가합니다.

**로그인 방법** - 관리자는 내부 또는 외부 사용자의 계정 접속 모드를 선택할 수 있습니다.

* **내부 사용자:** 내부 사용자의 로그인 모드로 Adobe ID 또는 단일 인증을 설정할 수 있습니다.
* **외부 사용자:** 외부 사용자의 경우 Adobe ID, 단일 인증 또는 Learning Manager ID를 설정할 수 있습니다.
...
강의를 완료한 후에 왼쪽 창에서 **[!UICONTROL &#39;피드백&#39;]**&#x200B;을 클릭하여 학습자에게 피드백을 받을 수 있는 설문지를 설정합니다. L1 및 L3 피드백 생성에 대한 자세한 내용은 [강의 기능 도움말 내용](/help/migrated/administrators/feature-summary/courses.md#add-l1-and-l3-feedback)을 참조하십시오.

**다중 시도**

**[!UICONTROL 설정]** > **[!UICONTROL 일반]** > **[!UICONTROL 다중 시도]**&#x200B;를 선택합니다.
...
토론 게시판 확인란을 활성화하면 학습자 앱 강의 페이지에서 토론 탭을 사용하여 학습자와 강사가 강의에 대한 의견을 올릴 수 있습니다. 그러나, 강의 레벨 설정에 이 기능을 선택하지 않았다고 표시될 경우 강의 레벨 설정이 책임자 설정에 우선합니다.
...
왼쪽 창에서 **[!UICONTROL Adobe Connect]**&#x200B;를 클릭하여 가상 강의실 세션을 호스팅하도록 Adobe Connect 계정을 구성합니다. 자세한 내용은 [Adobe Connect](adobeconnect-integration.md) 기능 도움말을 참조하세요.
...
<table>
 <tbody>
  ...
  <tr>
   <td>스킬/태그 가시성</td>
   <td>학습자에게 모든 스킬 및 태그가 표시됩니다. 모든 스킬 및 태그, 할당된 스킬 및 태그, 또는 학습자에게 표시되는 카탈로그의 일부만 표시할 수 있습니다.
   <p><b>중요-학습자 도우미 및 카탈로그 가시성</b></p>
   <p>계정에서 학습자 도우미를 사용하는 경우 도우미의 콘텐츠 소스로 선택된 카탈로그는 학습자별 카탈로그 가시성으로 범위가 지정되지 않습니다. 일부 교육이 카탈로그 보기에서 지정된 학습자에게 표시되지 않더라도 도우미는 구성된 카탈로그의 콘텐츠를 사용할 수 있습니다.</p>
   <p>Adobe은 학습자 도우미에 액세스할 수 있는 모든 학습자에게 (요약되거나 설명된 형식으로) 편안하게 노출시키는 콘텐츠가 포함된 카탈로그만 선택할 것을 권장합니다. </p>
   </td>
  ...
  <tr>
   <td height="20">삭제된 사용자 자동 삭제</td>
   <td>활성화되면 내부 사용자가 지정된 기간 동안 시스템에 액세스하지 않으면 자동으로 삭제됩니다. 이 기능은 학습자 역할만 맡은 사용자에게 적용됩니다. 액세스를 복원하려면 책임자에게 문의해야 합니다. 이 옵션을 활성화한 후 제거된 사용자가 ALM에서 영구적으로 삭제되는 시간(년)을 지정할 수 있습니다.</td>
  </tr>
  <tr>
  <tr>
   <td>카탈로그 레이블 표시</td>
  ...
  <tr>
   ...
   <td>
    ...
    <ul>
     <li><b>재설정</b> 아이콘을 클릭하여 <b>도움말</b> 및 <b>책임자에게 문의</b> 필드에서 기본값을 재설정할 수 있습니다.</li>
...
<table border="0" cellpadding="0" cellspacing="0" width="1709">
 <tbody>
  ...
  <tr>
   <td height="20">참고: 필터 형식 및 지속 기간은 기본적으로 꺼져 있으며 릴리스 이후 즉시 학습자에게 표시되지 않습니다. 책임자는 이를 활성화해야 합니다. </td>
  </tr>
  <tr>
   <td height="20">카탈로그 목록 표시</td>
   <td>활성화되면 학습자는 사용 가능한 모든 카탈로그 목록을 볼 수 있습니다. 학습자는 이를 사용하여 학습 객체가 표시되는 방법을 세밀하게 조정할 수 있습니다.
   <p><b>중요-학습자 도우미 및 카탈로그 가시성</b></p>
   <p>계정에서 학습자 도우미를 사용하는 경우 도우미의 콘텐츠 소스로 선택된 카탈로그는 학습자별 카탈로그 가시성으로 범위가 지정되지 않습니다. 일부 교육이 카탈로그 보기에서 지정된 학습자에게 표시되지 않더라도 도우미는 구성된 카탈로그의 콘텐츠를 사용할 수 있습니다.</p>
   <p>Adobe은 학습자 도우미에 액세스할 수 있는 모든 학습자에게 (요약되거나 설명된 형식으로) 편안하게 노출시키는 콘텐츠가 포함된 카탈로그만 선택할 것을 권장합니다. </p>
   </td>
  ...
  <tr>
   <td height="20">학습자 앱의 프로필 설정에서 학습자(DND 목록에서가 아님)는 다이제스트 전자 메일을 구독/구독 취소하도록 선택할 수 있습니다.</td>
  </tr>
  <tr>
  ...
  <tr>
   <td height="19">1. 더 추가 를 클릭하고 지정된 필드에 이름과 URL 또는 이메일 ID를 입력합니다. http:// 또는 https://를 URL 앞에 추가합니다.</td>
  </tr>
  <tr>
  ...
  <tr>
   <td height="19">재설정 아이콘을 클릭하여 도움말 및 책임자에게 문의 필드에서 기본값을 재설정할 수 있습니다.</td>
  </tr>
  <tr>
   <td height="20">모든 언어에 대해 바닥글의 링크를 사용자 정의할 수 있습니다. 언어 드롭다운 목록에서 언어를 선택하고 지정된 필드에 이름 및 URL을 추가합니다. 변경 사항을 저장하면 업데이트된 링크가 바닥글에 표시됩니다.</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>
    ...
    <p>이 기능은 강의에서만 사용할 수 있습니다. 학습 프로그램이나 인증서에는 평가 등급이 지원되지 않습니다.<br><br><b>참고: </b>이 변경은 학습자 앱에만 영향을 줍니다. </p>
    <p>다른 모든 앱(책임자, 작성자, 관리자, 사용자 정의 책임자, 사용자 정의 작성자)에서는 설정에서의 변경(평가 등급/강의 효과/등급 표시 비활성화)이 영향을 미치지 않습니다. </p>
    <p>새로운 계정의 경우 <b>등급 표시</b> 섹션에 기본적으로 <b>평가 등급</b> 옵션이 활성화됩니다.</p>
    <p>기존 계정의 경우 계정에 <b>강의 효과</b> 옵션이 이전에 활성화되었다면 <b>등급 표시</b> 섹션은 강의 효과 옵션이 선택된 상태로 활성화됩니다. <b>강의 효과</b> 옵션이 비활성화된 경우 <b>등급 표시</b> 섹션도 비활성화됩니다. <b>등급 표시</b> 섹션이 활성화되면, <b>평가 등급</b> 옵션이 기본적으로 활성화됩니다.</p></td>
  </tr>
  <tr>
   <td height="19">중단</td>
   <td>다음에서 사용 중지 옵션을 선택합니다.<li>지원이 중단되면 등록된 학습자는 작업을 보고 수행할 수 있지만 아직 등록되지 않은 학습자는 액세스 권한을 잃게 됩니다.</li><li>지원이 중지되면 등록된 학습자와 아직 등록되지 않은 학습자 모두 액세스 권한을 잃게 됩니다.</li><div><b>참고:</b> 개요 페이지에서 강의, 학습 경로 또는 인증을 취소할 수 있습니다.</div> </td>
  </tr>
  <tr>
   <td height="19">검색 결과에 등록된 모든 강의 표시</td>
   <td>활성화되면 학습자가 등록된 학습 경로 또는 인증의 일부라도 검색 결과에서 과정을 볼 수 있습니다.</td>
  </tr>
 </tbody>
</table>
 ...
 <tbody>
  <tr>
   <td>
    <p>학습 경로</p></td>
   <td>
    <p><b>학습 경로의 확장 기능 활성화</b> 옵션을 선택하면 책임자가 학습 경로에 학습 프로그램을 삽입하고 이러한 학습 경로를 강의에 반영할 수 있습니다. 이 옵션은 되돌릴 수 없습니다.<br></p></td>
  </tr>
  <tr>
   <td>
    <p>강사 관리<br></p></td>
  ...
  <tr>
    ...
    <td>
      <p>학습자가 강의/경로를 완료하면 다른 지정된 강의/경로 세트를 대체하여 완료로 표시할 수 있습니다. 학습자는 교대를 통해 완료한 것으로 표시된 강의/경로에 자동으로 등록되지 않으며 실제로 완료한 강의/경로에 대한 크레딧, 배지 및 점수만 받게 됩니다. 사용 가능한 옵션은 소급 완료가 활성화되었고 소급 불완제가 활성화되었습니다.
      </p>
    </td>
  </tr>
  </tr>
...
>[!NOTE]
>
>스킬 가져오기 설정이 활성화되면 계정 레이아웃을 클래식 보기로 전환할 수 없습니다. 즉, **스킬 가져오기** 옵션이 활성화된 후에는 클래식 계정으로 전환이 비활성화됩니다.
...
1. 내 사진/계정 옆에 있는 오른쪽 상단 모서리에서 펼쳐지는 화살표를 클릭하고, **[!UICONTROL &#39;프로필 설정&#39;]**&#x200B;을 선택합니다.
1. 팝업 대화창의 프로필 사진 영역에서 마우스를 움직이거나 **[!UICONTROL &#39;편집&#39;]**&#x200B;을 클릭하여 사진을 추가/변경할 수 있습니다.
1. 콘텐츠 **[!UICONTROL &#39;포맷&#39;]** 근처에 있는 **[!UICONTROL &#39;편집&#39;]**&#x200B;을 클릭하여 콘텐츠를 추가/변경합니다.
1. **[!UICONTROL 저장].**&#x200B;을 클릭합니다.

## 콘텐츠 폴더 {#content-folder}

Learning Manager는 개인 콘텐츠 폴더를 지원합니다. 책임자는 비공개 콘텐츠 폴더를 구성하고 사용자 정의 역할을 사용하여 특정 사용자 정의 작성자에게 액세스 권한을 제공할 수 있습니다. 표준 작성자(전체 작성자라고도 함)는 계속해서 계정에 있는 모든 콘텐츠에 액세스할 수 있습니다. 따라서 전체 작성자는 모든 폴더와 모든 콘텐츠에 대한 액세스 권한을 보유합니다.

콘텐츠 폴더는 책임자가 구성할 수 있습니다. 한 번만 구성되는 콘텐츠 폴더는 작성자에게 표시되며 작성자는 하나 또는 여러 폴더에 콘텐츠를 배치할 수 있습니다.

콘텐츠 폴더를 추가하려면 관리자 앱에서 **[!UICONTROL 설정]** > **[!UICONTROL 콘텐츠 폴더]**&#x200B;를 클릭하세요.
...
폴더를 추가하려면 창의 오른쪽 상단 모서리에 있는 **[!UICONTROL 추가]**&#x200B;를 클릭합니다.

**폴더 삭제**

폴더를 삭제할 수도 있습니다. 삭제할 폴더를 선택하고, [작업] 메뉴를 클릭하고, **[!UICONTROL 폴더 삭제]**&#x200B;를 클릭합니다.
...
* **작성자가 위치를 만들도록 허용**: 활성화되면 작성자가 만든 모든 위치가 &#39;모든 위치&#39; 탭에 나열됩니다. 학습자는 카탈로그 및 일정 필터에서도 이러한 위치를 확인할 수 있습니다.
* **작성자가 위치를 수정하고 삭제할 수 있도록 허용**:
활성화되면 작성자는 모든 강의실 위치를 수정하고 삭제할 수 있습니다. 작성자별 수정 사항은 보고서를 포함하여 플랫폼 전체에 반영됩니다.

## 자주 묻는 질문 {#frequentlyaskedquestions}

+++콘텐츠 라이브러리의 다른 폴더를 생성하는 방법

**[!UICONTROL 설정]** > **[!UICONTROL 콘텐츠 폴더]**&#x200B;를 클릭합니다. 폴더를 추가하려면 오른쪽 상단 모서리에 있는 **[!UICONTROL 추가]**&#x200B;를 클릭하고 대화 상자에 폴더의 이름 및 설명을 입력합니다.
...
**[!UICONTROL 설정]** > **[!UICONTROL 기본 정보]**&#x200B;에서 **[!UICONTROL 변경]**&#x200B;을 클릭하세요. 드롭다운 목록의 **[!UICONTROL 회계 연도 시작일]**&#x200B;에서 해당 월을 선택합니다.
+++
