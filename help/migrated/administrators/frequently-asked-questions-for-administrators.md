...
1. 왼쪽 창의 &#39;강의&#39;를 클릭합니다.
1. 관리자 지정 강의로 마우스를 가져간 뒤 **[!UICONTROL 관리자 지정 찾기]**&#x200B;를 클릭합니다.

1. 인스턴스 목록에서 **[!UICONTROL 관리자 지정]** 링크를 클릭합니다. 이는 **[!UICONTROL &#39;관리자 추가&#39;]** 링크 다음에 나옵니다.
...
+++특정 강의의 학습자를 등록하려면 어떻게 해야 합니까?

다음 단계를 따라서 학습자를 강의에 등록할 수 있습니다.

1. 책임자로 로그인한 뒤 왼쪽 창의 &#39;강의&#39;를 클릭합니다. 오른쪽 페이지에 모든 강의 목록이 나타납니다.
1. 학습자를 추가할 강의를 선택한 뒤 그 위에 마우스를 올립니다.
1. &#39;학습자 등록&#39;을 클릭하고 학습자 이름을 추가합니다. **참고:** 한 번에 1명 이상의 학습자를 추가할 수 있습니다.

+++

+++특정 스킬에 학습자를 할당하려면 어떻게 해야 합니까?

다음 단계를 따라서 학습자를 역량에 할당할 수 있습니다.

1. 책임자로 로그인한 뒤 왼쪽 창의 **[!UICONTROL &#39;스킬&#39;]**&#x200B;을 클릭합니다.
1. 각 역량에 대한 확인란을 클릭하여 하나 또는 여러 스킬을 선택하고 페이지의 오른쪽 상단 모서리에 있는 **[!UICONTROL 작업]** 드롭다운을 클릭합니다.
1. &#39;사용자에게 할당&#39;을 클릭합니다.
1. 사용자 이름을 입력하여 드롭다운 목록에서 선택한 다음 **[!UICONTROL &#39;저장&#39;]**&#x200B;을 클릭합니다.
...
+++학습 프로그램 세션을 생성하려면 어떻게 해야 합니까?

학습 프로그램을 생성하려면 아래 단계를 따르십시오.

1. 오른쪽 창의 &#39;학습 프로그램&#39;을 클릭합니다. 기존 학습 프로그램 목록이 있는 학습 프로그램 페이지가 나타납니다.
1. 페이지 오른쪽 상단 모서리에 있는 &#39;추가&#39;를 클릭합니다.\
   프로그램 이름, 개요, 설명을 입력한 뒤 &#39;저장&#39;을 클릭합니다.
1. 왼쪽 창의 &#39;강의&#39;를 클릭합니다.
1. 각 강의 타일의 &#39;+&#39; 버튼을 클릭하면 1개 이상의 강의를 추가할 수 있습니다.

   >[!NOTE]
   >
   >인스턴스에 학습자를 등록하기 전에 학습 프로그램을 게시해야 합니다.

1. 왼쪽 창의 &#39;인스턴스&#39;를 클릭한 뒤, 페이지 오른쪽 모서리에 있는 **[!UICONTROL &#39;새 인스턴스 추가&#39;]**&#x200B;를 클릭하여 인스턴스의 세부 정보를 클릭합니다.

학습 프로그램에 대한 자세한 내용은 [학습 프로그램 기능](/help/migrated/administrators/feature-summary/learning-programs.md)을 참조하세요.

+++

+++모든 역할에 대한 보고서를 수정 또는 사용자 정의하려면 어떻게 해야 합니까?
...
회사 프로필을 수정하려면 왼쪽 창의 **[!UICONTROL &#39;설정&#39;]**&#x200B;을 클릭한 뒤, 페이지의 오른쪽 상단 모서리에 있는 **[!UICONTROL &#39;변경&#39;]**&#x200B;을 클릭합니다.
...
1. 필터를 사용하여 강의 목록을 필터링할 수 있습니다.

전체, 게시됨, 중단됨 등 각 옵션을 클릭하여 강의에 필터를 적용할 수 있습니다. 역량을 클릭한 뒤, 각 역량을 선택하면 역량 기준으로 검색할 수도 있습니다.

선택에 따라, 필터가 적용된 강의 목록을 보고 필요한 강의를 선택할 수 있습니다.

+++

+++응용 프로그램의 테마를 변경할 수 있습니까? 어떻게 해야 합니까?
...
1. 책임자로 로그인한 뒤 왼쪽 창의 &#39;배지&#39;를 클릭합니다.
...
1. 보고서 페이지에서 오른쪽 상단 모서리에 있는 **[!UICONTROL &#39;추가&#39;]**&#x200B;를 클릭합니다.

   **[!UICONTROL 보고서 추가]** 대화 상자가 나타납니다.

1. 필수 필드를 전부 채운 뒤 &#39;저장&#39;을 클릭합니다.
...
1. 왼쪽 창에서 &#39;전자 메일 템플릿&#39;을 클릭한 다음 &#39;일반&#39;, &#39;사용자 등록&#39;, &#39;완료&#39;, &#39;피드백&#39; 탭을 선택합니다.
...
1. 왼쪽 창의 **[!UICONTROL &#39;사용자&#39;]**&#x200B;를 클릭합니다.
1. 왼쪽 창의 **[!UICONTROL 외부]**&#x200B;를 클릭합니다.
1. 페이지 오른쪽 상단 모서리에 있는 **[!UICONTROL &#39;추가&#39;]**&#x200B;를 클릭합니다.
...
책임자는 등록 url을 복사하여 외부 등록 그룹에 전송할 수 있습니다. 외부 사용자는 Learning Manager 응용 프로그램에 등록 및 로그인한 뒤 강의에 액세스할 수 있습니다.
...
+++인증 디자인을 사용자 정의할 수 있습니까? 어떻게 해야 합니까?
...
1. 책임자로 로그인한 뒤 왼쪽 창의 **[!UICONTROL 회사 정보]**&#x200B;를 클릭합니다.
...
+++학습자의 배경 이미지를 변경하려면 어떻게 해야 합니까?

Learning Manager 지원팀에 문의하십시오.

+++

+++나의 Learning Manager 계정 ID는 어디에서 찾을 수 있습니까?
...
+++LMS에 있는 모든 강의 목록을 볼 수 있는 보고서가 있습니까? 아니면 누군가 가져올 수 있는 보고서가 있습니까?
