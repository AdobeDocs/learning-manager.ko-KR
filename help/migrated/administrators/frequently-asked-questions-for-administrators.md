...
예. CSV 업로드 기능으로 사용자를 일괄 추가할 수 있습니다. 다음을 수행합니다.  [여기](/help/migrated/administrators/add-users-in-bulk.md) 를 참조하십시오.
...
강의나 학습 프로그램을 게시한 뒤에도 편집할 수 있습니다. 자세한 내용은 다음을 참조하십시오.  [강의](/help/migrated/administrators/feature-summary/courses.md) 및  [학습 프로그램](/help/migrated/administrators/feature-summary/learning-programs.md) 도움말 콘텐츠.
...
보고서를 생성하거나 볼 수 있는 것은 관리자와 관리자뿐입니다. 자세한 내용은 [보고서 기능](/help/migrated/administrators/feature-summary/reports.md) 를 참조하십시오.
...
강의를 추가하려면 역할을 작성자로 전환해야 합니다. 다음과 같은 상태에 따라서만 사용 가능한 강의 목록을 볼 수 있습니다. **[!UICONTROL 완료]**, **[!UICONTROL 게시됨]**, 및 **[!UICONTROL 중단됨]**.
...
신규 사용자에게는 기본적으로 학습자 역할이 할당됩니다. 을 클릭하여 학습자에게 책임자 또는 작성자 역할을 할당할 수 있습니다. **[!UICONTROL 액션]** 를 클릭하고 선택 **[!UICONTROL 역할 할당]** > **[!UICONTROL 작성자 지정]** 또는 **[!UICONTROL 관리자 설정]**.
