...
Go1 통합이 개선되어 미리 보기 및 구매 콘텐츠 모델로 전환하는 동시에 재생 목록 관리, 학습 경로 생성 및 반복 인증 워크플로우를 지원합니다.

**새로운 기능**

* AI 채팅 지원이나 수동 선택을 사용하여 Go1 내에서 직접 플레이리스트를 만들고 관리합니다.
* Go1 플레이리스트를 Adobe Learning Manager 학습 경로로 쉽게 변환합니다.
* 자동 진행률이 재설정된 반복 인증 주기에 Go1 강의를 포함합니다.
* 향상된 탐색 및 콘텐츠 큐레이션을 위한 업그레이드된 콘텐츠 검색 인터페이스.
* 무료 콘텐츠에서 투명한 비용 모델로 전환.
...
책임자는 위치, 역할, 제품 및 기타 기준에 따라 다양한 학습자 그룹에 맞게 조정된 Go1 강의로 플레이리스트를 만들 수 있습니다. 재생 목록은 수동으로 만들거나 AI를 사용하여 생성할 수 있습니다.

재생 목록을 만들려면 다음을 수행하십시오.

1. 관리자 권한으로 Adobe Learning Manager에 로그인합니다.
2. 왼쪽 탐색 창에서 **[!UICONTROL 콘텐츠 마켓플레이스]**&#x200B;를 선택합니다.
...
b. **[!UICONTROL 직접]**: 강의를 수동으로 추가하여 재생 목록을 만듭니다.
   ...
   _Adobe Learning Manager에서 플레이리스트 만들기를 선택하여 학습자를 위한 대상 강의를 구성하고 전달하여 새 플레이리스트를 만듭니다._

**AI로 재생 목록 만들기**

책임자는 AI 프롬프트에 재생 목록 설명을 입력할 수 있습니다. AI가 관련 강의를 큐레이션하고 요구 사항에 따라 플레이리스트를 만듭니다.
...
4. 목록에서 스킬을 선택한 다음 강의 지속 기간을 선택하고 재생 목록을 입력합니다.
5. **[!UICONTROL 재생 목록 생성]**&#x200B;을 선택합니다.

   ![](assets/select-generate-playlist.png)
   _관련 스킬 및 강의 기간을 선택하여 Adobe Learning Manager에서 플레이리스트 사용자 지정_


플레이리스트는 10개의 강의로 생성되며 책임자는 이를 사용하여 학습 경로를 생성할 수 있습니다.

![](assets/created-playlist.png)
_Adobe Learning Manager에서 큐레이트된 판매 엔지니어 스킬 향상 플레이리스트 검토_
...
6. **[!UICONTROL 라이브러리]**&#x200B;에서 **[!UICONTROL Go1 과정 선택 화면]**&#x200B;에서 재생 목록을 검색하고 선택합니다.

   >[!NOTE]
   >
   >재생 목록을 쉽게 찾으려면 내가 만든 항목 필터를 설정해야 합니다.

   ![](assets/select-save-to-add-playlist.png)
   _Adobe Learning Manager의 Go1 과정 라이브러리에서 영업 엔지니어 재생 목록 선택_

7. **[!UICONTROL 라이브러리에 추가]**&#x200B;를 선택한 다음 **[!UICONTROL 저장]**&#x200B;을 선택합니다.

   ![](assets/add-playlist-to-lp.png)
   _Adobe Learning Manager의 Go1 라이브러리에서 영업 엔지니어 스킬 향상 재생 목록을 선택하고 가져오기_

8. **[!UICONTROL 추가]**&#x200B;를 선택한 다음 **[!UICONTROL Publish]**&#x200B;을 선택합니다.
