...
>[!IMPORTANT]
>
>Adobe Learning Manager 2025년 10월 릴리스가 이제 출시되었습니다. 최신 기능 및 개선 사항에 대한 자세한 내용은 [새로운 기능](/help/migrated/whats-new.md)을 참조하세요. 이 페이지는 다음 릴리스의 새로운 기능과 개선 사항으로 업데이트됩니다. 더 많은 업데이트가 곧 제공됩니다.
...
학습자 성적 증명서 보고서에 대한 자세한 내용은 이 [문서](/help/migrated/administrators/feature-summary/reports/learner-transcripts.md)를 참조하십시오.
...
>[!NOTE]
>
>위의 CSV 변경 사항은 증분 사용자를 사용하는 계정에만 적용됩니다.
