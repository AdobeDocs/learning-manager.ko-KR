...
1. [Learning Manager 패키지 URL](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tDb000000HciS)을(를) 실행합니다.
...
패키지를 설치하면 새 권한 집합인 **Adobe Learning Manager 사용자**&#x200B;가 생성됩니다. 권한 집합으로 이동하여 사용자를 추가합니다.
