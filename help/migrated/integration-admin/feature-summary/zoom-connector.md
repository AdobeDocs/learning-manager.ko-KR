...
Zoom에서 앱을 만들 때 다음 범위가 선택되어 있는지 확인하십시오.

| 범위 설명 | 확대/축소 범위 |
|---|---|
| 모든 사용자 모임 보기 | 모임:read:관리자 |
| 모든 사용자 회의 보기 및 관리 | 모임:write:관리자 |
| 보고서 데이터 보기 | 관리자:read:보고 |
| 모든 사용자 정보 보기 | 사용자:read:관리자 |
| 사용자 관리 | 사용자:write:관리자 |
| 모임 등록자 추가 | 모임:write:등록자:관리자 |
| 모든 모임 등록자 나열 | meeting:read:list_registrants:admin |
| 하위 계정 모임 관리 | meeting:write:meeting:master |
| 모임 참가자 보고서 보기 | report:read:list_meeting_participants:admin |
