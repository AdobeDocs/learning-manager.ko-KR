...
3. **[!UICONTROL 등록]**&#x200B;을 선택하고 다음 정보를 추가합니다.
   ...
   * **[!UICONTROL 도메인 리디렉션]**: Adobe Learning Manager이 권한 부여 후 리디렉션할 수 있는 도메인(예: [http://learningmanager.adobe.com](http://learningmanager.adobe.com))을 지정하십시오.  여러 개의 유효한 URL을 지정할 수 있습니다.
...
**[!UICONTROL 제출]**&#x200B;을 선택하면 액세스 토큰이 확인되고 다음 JSON 개체를 받게 됩니다.
...
| instance.badge | 강의 인스턴스 완료를 위해 할당된 배지 |
...
| 리소스 | 모듈 내의 각 컨텐츠 리소스를 나타냅니다. &quot;loResource&quot; 내에 캡슐화된 모든 리소스는 학습 목적에는 같지만, 콘텐츠 로케일의 전송 유형에서는 서로 다릅니다. |
...
| 403 | 사용 금지. 액세스 권한 없음 | 리소스에 액세스할 수 있는 권한이 없습니다. 토큰에 올바른 범위(관리자:read, 학습자:write 등)가 있는지 확인하십시오. |
