...
학습자로서 귀하는 Slack 계정에 CP Prime 앱을 설치할 수 있습니다. 앱을 설치하려면 귀하의 Slack 계정에서 앱 디렉터리를 열고 Learning Manager를 검색합니다. 앱을 다운로드 및 설치합니다. 계정에서 앱이 승인되지 않는 경우 통합 책임자에게 승인을 요청합니다. 승인된 경우, 로그인할 수 있습니다.
...
1. **[!UICONTROL 응용 프로그램]** 페이지로 돌아갑니다. 승인하면 Slack이 **[!UICONTROL &#39;외부 앱&#39;]** 탭에 나타납니다.
