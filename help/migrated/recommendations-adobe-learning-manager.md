...
당사에서는 데이터 준비 연습의 일환으로 두 개의 CSV 템플릿을 제공합니다.
...
PRL 권장 사항이 활성화되면 이전 상태로 되돌릴 수 없습니다. 활성화 중에 Adobe Learning Manager에 변경 사항이 영구적으로 적용됨을 알리는 확인 메시지가 표시됩니다. 권장 사항이 적용되기 전까지 변경 사항을 실행 취소하거나 수정할 수 있습니다.

![라이브로 이동](assets/computerdescription-automatically.png)
*실시간으로 추천*

![라이브로 이동](assets/recommendations-irreversible.png)
*추천 경고*
...
![설치 권장 사항](assets/image575540.png)
*학습자가 추천 설정*
