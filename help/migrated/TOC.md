...
* [Learning Manager 사용 안내서](user-guide.md)
* 소개 {#introduction}
   ...
   * [Microsoft Teams을 위한 Adobe Learning Manager 앱](adobe-learning-manager-app-microsoft-teams.md)
   * [Learning Manager는 GDPR을 준수함](kb/prime-gdpr.md)
   * [Learning Manager 접근성](accessibility-learning-manager.md)
   * [사용자 정의 도메인 지원](custom-domain.md)
   * [Adobe Learning Manager의 Recommendations](recommendations-adobe-learning-manager.md)
   * [Adobe FTP 관리자에서 전환](transition-from-ftp-manager.md)
* 시작하기 {#get-started}
   * [관리자로 시작하기](administrators/feature-summary/getting-started-admin.md)
   * [작성자로 시작하기](authors/feature-summary/getting-started-author.md)
...
* 책임자 {#admin}
   ...
   * [강의 모듈, 인스턴스 및 학습 프로그램 생성](administrators/feature-summary/courses.md)
   ...
   * [스킬과 레벨 만들기 및 수정](administrators/feature-summary/skills-levels.md)
   ...
   * [대기자 및 출석 관리](administrators/feature-summary/waitlist-attendance-management.md)
   ...
   * [책임자로 소셜 학습 모니터링 및 중재](administrators/feature-summary/social-learning-configurations-as-an-admin.md)
...
* 통합 책임자 {#integration}
   ...
   * [AEM과 Learning Manager 통합](integrate-aem-learning-manager.md)
...
* 작성자 {#authors}
   ...
   * [다른 로케일에서 학습 객체 추가](authors/feature-summary/add-new-language-learning-objects.md)
   * [사용자 알림](authors/feature-summary/user-notifications.md)
   * [전자 메일 템플릿](authors/feature-summary/email-templates-author.md)
   * [강의 모듈을 선택하려면 어떻게 해야 합니까?](authors/how-to-choose-modules.md)
...
* 학습자 {#learner}
   ...
   * [대기자 및 출석 관리](learners/feature-summary/waitlist-attendance-management.md)
   ...
   * [모바일 및 태블릿용 학습자 앱](learners/feature-summary/ipad-android-tablet-users.md)
...
* 자주 묻는 질문 {#faq}
   ...
   * [작성자를 위한 자주 묻는 질문](authors/frequently-asked-questions-for-authors.md)
   * [강사를 위한 자주 묻는 질문](instructors/frequently-asked-questions-for-instructors.md)
   * [관리자를 위한 자주 묻는 질문](managers/frequently-asked-questions-for-managers.md)
* 기술 자료 {#knowledge-base}
   ...
   * [Adobe Learning Manager와 Okta Active Directory 통합](kb/okta-active-directory-integration.md)
   * [강의에서 학습자를 볼 수 없음](kb/unable-view-learners-course.md)
   * [달력을 볼 수 없음](kb/unable-view-calendar.md)
   * [강의를 완료한 후 모듈이 완료로 표시되지 않음](kb/module-not-marked-complete.md)
   * [강의를 완료한 후 스킬을 달성할 수 없음](kb/skill-not-achieved.md)
   * [라디오 단추가 없음](kb/selection-button-invisible.md)
