...
이에 비해 ALM은 파일 기반 및 LTI 기반 리소스에 대한 버전 컨트롤을 지원하며, 여기서 작성자는 파일을 바꾸거나 시작 링크를 업데이트할 수 있습니다. 이러한 컨트롤은 SN 통합에 사용할 수 없으므로 ALM은 Second Nature 콘텐츠에 대한 버전 범핑을 지원하지 않습니다.
