...
>[!IMPORTANT]
>
>이 릴리스 정보에 설명된 기능은 베타 릴리스의 일부로 제공됩니다. Adobe Learning Manager beta 기능은 평가 목적으로 제공되며, 일반 가용성 릴리스 전에 수정, 제한 또는 제거될 수 있습니다. 기능 이름, 동작 및 구성 옵션은 예고 없이 변경될 수 있습니다.
...
6. 오른쪽 상단에는 **작업** 드롭다운 목록이 열려 더 많은 옵션(회색으로 표시된 옵션 포함)을 표시합니다. **모든 사용자에게 이메일 보내기**는 옵션 중 하나입니다.
