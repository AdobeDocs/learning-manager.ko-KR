...
>[!NOTE]
>
>중단된 강의의 전체 목록은 **&#39;중단됨&#39;** 탭을 클릭하면 볼 수 있습니다.
...
관리자는 강의 모듈을 보면서 **&#39;학습자로 미리 보기&#39;** 옵션을 클릭하여 강의를 미리 보기할 수 있습니다.
...
1. 검색 필드를 사용할 수 있습니다. 오른쪽 상단 모서리에 표시된 검색 아이콘을 클릭합니다. 검색창이 나타납니다. 강의 이름 또는 강의와 관련된 키워드를 입력하여 강의/학습 경로를 찾습니다. Captivate, C, Java 및 HTML 등 미리 정의된 태그로 검색할 수도 있습니다. 검색 필드 내에서 태그를 검색할 수 있습니다. 즉, 검색 필드에 입력을 하면 태그가 표시됩니다. 고유 ID로도 검색을 실행할 수 있습니다.
1. 필터를 사용하여 강의/학습 경로/인증 목록을 필터링합니다. 전체, 게시됨, 중단됨 등의 상태로 강의에 필터를 적용할 수 있습니다.

**역량**&#x200B;을 선택하고 선택하여 역량을 기준으로 검색할 수 있습니다. 관리자는 네 가지 방법으로 강의를 정렬하여 더욱더 쉽게 필요한 강의를 찾을 수 있습니다. 정렬 기준 을 클릭하고 알파벳 오름차순, 알파벳 내림차순, 강의 갱신일, 강의 생성일 또는 강의 효과를 선택합니다.
...
사용자 이름이나 각 질문을 기반으로 특정 학습 경로의 퀴즈 점수를 볼 수 있습니다. 적절히 &#39;사용자&#39; 또는 &#39;질문&#39; 탭을 선택합니다. 한 번에 한 강의의 퀴즈 점수가 나타납니다. 다른 강의의 퀴즈 점수를 보려면 드롭다운에서 강의 이름을 변경합니다. 각 강의의 퀴즈 점수를 내보낼 수도 있습니다. 드롭다운 목록에서 인스턴스 유형을 선택하여 학습 경로의 각 인스턴스를 기준으로 점수를 봅니다.
...
1. 관리자 역할로 로그인한 뒤 왼쪽 창의 &#39;인증&#39;을 클릭합니다. 게시된 탭 목록에서 각 인증에 마우스를 올리고 &#39;학습자 등록&#39;을 클릭합니다. 또는 게시된 인증 타일을 클릭한 뒤 왼쪽 창에서 &#39;학습자&#39;를 클릭할 수도 있습니다. 학습자 추가를 시작하려면 학습자 페이지의 오른쪽에서 &#39;등록&#39;을 클릭합니다.
1. 위의 두 단계에서 각기 학습자 등록 옵션을 클릭하고 나면 &#39;학습자 등록&#39; 팝업 대화 상자가 나타납니다. 학습자의 이름, 프로필을 입력하고 드롭다운 목록에서 학습자의 이름을 선택한 다음 &#39;저장&#39;을 클릭합니다.
...
1. 그러면 관리자는 요청을 승인하거나 거절합니다.
1. 관리자는 승인 또는 거절이 예상대로 수행되지 않은 경우 확인 또는 오류 메시지를 받습니다.
1. 학습자는 과정 등록에 대한 알림 또는 승인이나 거절 메시지를 받습니다.
