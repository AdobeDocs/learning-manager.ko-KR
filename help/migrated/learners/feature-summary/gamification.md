...
* **사용자 그룹:** 언제든지 순위를 견주고 싶은 팀 회원의 프로필을 선택할 수 있습니다. **[!UICONTROL 겨뤄 보기]** 옵션을 사용합니다. 사용자 그룹 선택 필드에서 그룹을 입력 및 선택합니다. 팀원의 최근 점수와 함께 모든 팀원 목록이 아래에 나열됩니다. 내부 사용자와 외부 사용자 모두 목록을 볼 수 있지만 내부 사용자만 다른 내부 학습자를 검색할 수 있습니다.
...
학습자는 5개의 게임화 과제를 사용할 수 있습니다. 학습자 홈페이지 창의 오른쪽 상단 모서리에 있는 원 안에서 게임화 점수를 볼 수 있습니다. 각 과제의 할당 점수를 보려면 &#39;게임화&#39;를 클릭합니다.
...
이 과제는 학습자가 지정된 수의 강의에 등록하여 월/분기/연 내에 완료했을 때 적용할 수 있습니다. 이러한 경우 관리자는 이 과제에 점수를 할당하여 학습자를 독려할 수 있습니다.

가능한 시나리오:

1. 월/분기/연 내에 1개의 강의에 등록한 학습자는 50점을 획득합니다.
1. 월/분기/연 내에 2개의 강의에 등록한 학습자는 150점을 획득합니다.
...
1. 월/분기/연 내에 2개의 강의에 등록한 학습자는 100점을 획득합니다.
...
1. 2개의 역량을 달성한 사용자는 300점을 획득합니다.
1. 3개의 역량을 달성한 사용자는 600점을 획득합니다.
1. 4개의 역량을 달성한 사용자는 900점을 획득합니다.
...
1. 레벨 1을 달성한 사용자는 100점을 획득합니다.
1. 레벨 2를 달성한 사용자는 200점을 획득합니다.
1. 레벨 3을 달성한 사용자는 500점을 획득합니다.

>[!NOTE]
>
>이 과제에는 기한을 적용할 수 없습니다. 책임자는 각 시나리오에 대한 레벨의 값을 수정할 수 있습니다. 학습자가 더 높은 레벨을 달성하고 나서 더 낮은 수준의 역량을 달성하면 높은 레벨에서만 점수를 획득합니다.
