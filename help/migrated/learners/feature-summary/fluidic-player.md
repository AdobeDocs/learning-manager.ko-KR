...
Fluidic Player는 끊김 없는 혼합 학습 경험을 제공하는 학습자용 콘텐츠 수료 플랫폼입니다. 이 플레이어에서는 지원되는 모든 형식을 끊임없이 플레이할 수 있습니다. 작성자 및 관리자는 플레이어를 사용하여 콘텐트를 미리 보기할 수 있습니다.
...
또한, Learning Manager API를 사용하여 Fluidic Player를 외부 웹 사이트나 응용 프로그램에 내장할 수도 있습니다.
...
**11개 언어 지원**: Fluidic Player는 11개 언어를 지원합니다. 그 내용은 다음과 같습니다.
