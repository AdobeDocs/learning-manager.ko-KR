...
**카탈로그**&#x200B;는 회사 계정 내 학습자 역할이 사용할 수 있는 모든 강의, 학습 프로그램, 인증 및 작업 지원으로 구성됩니다.

학습자는 **기본 카탈로그**&#x200B;에서 할당되었거나 이용할 수 있는 모든 학습 객체(학습 프로그램, 강의 및 인증)를 볼 수 있습니다. 역할, 직함, 사용자 그룹, 프로필 등을 기준으로 학습자마다 고유한 학습 객체를 갖게 됩니다.

제품, 작업 역할, 유형, 필요한 시간, 스킬, 키워드 등 다양한 범주를 기반으로 학습 객체를 정렬할 수 있습니다. 왼쪽 창에 있는 학습 객체, 스킬, 완료 상태 등의 옵션을 사용하여 필터링할 수도 있습니다.

페이지의 위에 있는 검색 막대에 익숙한 학습 객체의 이름을 입력합니다. 학습자는 이 ![](assets/icon-list.png) 아이콘을 선택하여 눈금과 목록 보기 사이를 전환할 수 있습니다.
...
귀하도 교육 지속 기간에 따라 필터링할 수 있습니다. 지속 기간 필터에는 이전 작업 및 테스트 지속 기간이 포함되지 않습니다.
...
학습자 앱의 정렬 기능은 콘텐츠 및 인터페이스 언어를 기반으로 개인화된 강의 추천 항목을 제공합니다. 이 기능&#x200B;을 통해 학습자가 선호하는 언어로 강의를 찾고 보다 지능적인 정렬 옵션을 활용하는 프로세스가 간소화되었습니다.
