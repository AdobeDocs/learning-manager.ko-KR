...
화면 하단의 책 아이콘 옆에 있는 아이콘을 탭합니다. 모든 관련 학습 객체가 있는 카탈로그를 즉시 볼 수 있습니다. 격자 레이아웃으로 보거나 세부 보기를 선택할 수 있습니다. 추천을 선택하면 학습 이력을 기반으로 강의 추천을 볼 수 있습니다.
...
화면 왼쪽 상단 모서리에 있는 ![](assets/hamburger.jpg) 메뉴를 눌러 프로필, 알림과 계정 설정을 봅니다.
...
1. QR 코드를 스캔하려면 화면 왼쪽 상단의 ![](assets/hamburger.jpg)을(를) 탭합니다.
1. **QR 코드 스캔**&#x200B;을 탭합니다.
...
1. **완료 증명**&#x200B;을 누르고 파일(예: pdf 또는 이미지)을 업로드합니다.
...
* 상태가 **승인 보류 중 및 승인됨**&#x200B;이면 파일을 제출할 수 없습니다.
...
학습자가 강의를 시작하면 학습자는 아래 스크린샷과 같이 화면에 파일을 업로드할 수 있는 링크와 함께 **파일 제출** 상태가 보류 중으로 표시됩니다.
...
파일을 업로드하면 상태가 **승인 보류 중으로 변경됩니다.**. 강사는 [보류 중인 제출](/help/migrated/instructors/feature-summary/learners.md)의 목록을 보고 강사 웹 앱을 통해 제출을 승인하거나 거부합니다.

강사가 제출을 승인하면 학습자 모바일 앱의 상태가 **승인됨**&#x200B;으로 변경됩니다.

<!--![](assets/approved.jpg)-->

강사가 제출을 거부하면 학습자 모바일 앱의 상태가 **거부됨**(으)로 변경됩니다.
