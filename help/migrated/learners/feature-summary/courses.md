...
Adobe Learning Manager에서 학습자는 강의, 학습 프로그램 및 인증에 액세스할 수 있습니다. 학습자는 카탈로그를 사용하여 사용 가능한 모든 강의를 찾아보거나 원하는 강의에 직접 등록할 수 있습니다. 학습자는 [학습] 탭에서 등록된 모든 강의와 해당 강의에 할당된 강의를 확인할 수 있습니다.

>[!NOTE]
>
>학습자는 Apple Store에서 Learning Manager iPad 앱을 설치하고 Google Play에서 Learning Manager Android 앱을 설치하고 모바일 장치에서 강의에 액세스할 수도 있습니다. 모든 학습자 기능을 앱에서도 사용할 수 있습니다. 학습자는 오프라인으로 강의를 수강한 다음 온라인에서 원활히 액세스할 수 있습니다. 자세한 내용은 iPad 및 Android 태블릿 사용자](ipad-android-tablet-users.md) 기능을 참조하십시오[.

## 강의 보기 {#viewingcourses}

학습자가 사용 가능한 모든 강의 목록을 볼 수 있습니다. 홈 페이지 또는 왼쪽 창에서 내 학습을 클릭하여 등록한 모든 과정을 볼 수 있습니다.
...
이는 과정 콘텐트에 대한 학습자 피드백의 결과, 학습자에 대한 과정 퀴즈 결과, 그리고 과정의 학습을 기반으로 학습자를 평가하는 관리자의 피드백이 조합된 것입니다.
...
1. 오른쪽 상단 모서리에 표시된 검색 아이콘을 클릭합니다. 검색창이 나타납니다. 과정/학습 프로그램 이름 또는 과정과 관련된 키워드를 입력합니다. 메타데이터, 메모, 기술, 배지 또는 태그로 강의를 검색할 수 있습니다. 검색 필드 내에서 태그를 검색할 수 있습니다. 즉, 검색 필드에 입력을 하면 태그가 표시됩니다.
1. 학습자가 유형, 스킬, 태그 및 상태를 사용하면 카탈로그 페이지의 검색 결과를 구체적으로 볼 수 있습니다.

[정렬 기준]을 클릭하고 드롭다운 메뉴에서 선택하여 관련성, 이름 또는 게시 날짜별로 과정을 정렬할 수 있습니다.

검색 결과 페이지에서 과정 기간&#x200B;**및**&#x200B;과정 형식에&#x200B;**따라**&#x200B;과정을 필터링할 수 있습니다. 이렇게 하면 과정을 검색할 때 유연성이 향상되고 나에게 적합한 과정을 찾을 수 있습니다.
...
1. 학습자는 강의/학습 프로그램에 직접 등록할 수 있습니다.
   ...
   1. 강의/학습 프로그램이 관리자 승인 유형인 경우 학습자는 승인 보류&#x200B;**상태로 전환**&#x200B;됩니다. 관리자의 승인 후 학습자는 과정에 등록됩니다.
...
그러나 카탈로그 아래에 나열된 과정 위로 마우스를 이동하고 탐색을 클릭하여 진행할 수 있는 옵션이 있습니다. 등록 페이지가 나타납니다. 강의를 강의 목록에 넣으려면 페이지의 오른쪽 상단 모서리에 있는 &#39;등록&#39;을 클릭합니다.
...
>[!NOTE]
>
>학습자가 두 개의 다른 세션에 동시에 등록하거나 겹치는 시간에 등록하는 경우 충돌 메시지가 표시되어야 합니다.

## 학습자로의 워크플로우

학습자는 등록 후에만 강의를 평가할 수 있습니다. 홈&#x200B;**페이지,**&#x200B;내 학습&#x200B;**페이지 및**&#x200B;카탈로그&#x200B;**에서 모든 강의의**&#x200B;평균 별점을 볼 수 있습니다.

1. 학습자&#x200B;**로**&#x200B;로그인합니다. 그러면 홈 페이지가&#x200B;**로드됩니다**.

1. 검색 막대에 강의명을 입력하여 강의를 검색합니다. 또는 왼쪽 창에서 &#39;내 학습&#x200B;**&#39; 또는**&#39;카탈로그&#x200B;**&#39;를 클릭하여**&#x200B;표시된 과정 목록에서 선택할 수 있습니다.

1. 과정을 선택한 후 등록을&#x200B;]**클릭합니다**[!UICONTROL .

   ![](assets/cp-sr-enroll.png)
   *과정 등록*

1. 그에 맞춰 강의를 평가할 별의 수를 선택합니다. 1이 가장 낮고, 5가 가장 높은 점수입니다. 그런 다음 제출을&#x200B;]**클릭합니다**[!UICONTROL .
...
강의는 평균 등급 기준으로 정렬됩니다. Catalog **에서 사용할 수 있는 오른쪽 상단 모서리에 있는 [정렬 기준] 드롭다운에서 사례를 정렬할 수 있습니다**.

## 수강 {#consumingnbspacourse}

강의에 등록하면 &#39;강의 시작&#39;을 클릭하여 강의를 시작할 수 있습니다. 또는 [학습&#x200B;]**] 탭의 [과정]**]을 **[!UICONTROL 클릭합니다**[!UICONTROL . 수강할 강의를 선택합니다.
...
**목차** - 코스를 수강하는 동안 플레이어는 창의 왼쪽 창에 특정 코스에 대한 목차를 표시합니다. 각 주제를 클릭하면 바로 검색할 수 있습니다.

**책갈피** - 강좌 모듈에 모듈 TOC가 있는 경우 나중에 참조할 수 있도록 TOC 모듈의 항목을 책갈피할 수 있습니다. 북마크가 표시되면 TOC 항목 옆에 리본 아이콘이 나타납니다. 북마크는 리본을 다시 클릭하면 삭제할 수 있습니다.
...
**폐쇄 캡션** - Adobe Captivate에서 개발한 강의의 경우 과정 개발 중에 폐쇄 캡션이 활성화되면 학습자가 자막을 볼 수 있습니다. 플레이어 하단의 &#39;CC&#39;를 클릭합니다. 닫힌 자막 옵션은 8.0.2 HTML 콘텐트에서만 사용할 수 있습니다. 다른 모든 유형의 모듈에서는 CC 옵션이 재생 표시줄에 나타나지 않습니다.
...
**전체 화면** 플레이어의 오른쪽 하단 모서리에 있는 전체 화면 아이콘을 클릭하여 전체 화면 창에서 강좌를 봅니다.

**탐색 단추** 위/아래 화살표를 클릭하여 pdf, docx 및 pptx 콘텐트의 슬라이드를 이동할 수 있습니다. 모든 유형의 콘텐트에서 다음 주제로 이동할 때 슬라이드 화살표가 사용됩니다.

**강의 닫기:** 플레이어의 오른쪽 상단 모서리에 있는 닫기(x) 아이콘을 클릭하여 강의에서 나갑니다.

*강좌를 종료한 후 강좌 설명 페이지에서 재방문 버튼을 클릭하여 강좌를 다시 방문할 수 있습니다.*

## 평가 등급

과정에 등록한 후에만 학습자는 해당 과정에 별표 피드백을 제공할 수 있습니다. 강의의 강의 개요 페이지에서 학습자는 강의를 별점(최저 1점, 최고 5점)으로 평가할 수 있습니다.

![](assets/star-rating.png)
*피드백으로 별 등급 제공*

학습자는 특정 별(5개 만점)을 선택하고 등급을 제출할 수 있습니다. 학습자는 다른 별을 클릭하여 선택 항목을 편집할 수도 있습니다. 제출되면 피드백에 대한 감사 메시지가 표시됩니다.

학습자가 피드백을 다시 제출하려면 메시지를 클릭합니다. **제출** 버튼이 다시 활성화됩니다. 학습자는 과정 등록 후 여러 번 별 등급을 제공할 수 있습니다. 가장 최근의 등급만 인정됩니다.

학습자가 등급을 제공하면 평균 별점 및 강의 개요&#x200B;**페이지에서 별점 평가 기능을 제공한 학습자의 수입니다**.
...
콘텐츠 마켓플레이스 옵션은 학습자 앱의 왼쪽 창에 있습니다. 옵션을 클릭하면 모든 코스/전체 카탈로그 및 선별된 재생 목록을 볼 수 있습니다.
...
![](assets/catalog.png)
*Marketplace에서 과정 미리 보기*

책임자가 다양한 강의를 살펴보고 미리 볼 수 있도록 초대하면 알림이 표시됩니다.

학습자는 큐레이팅된 재생 목록&#x200B;**섹션에서 전체 카탈로그 또는 선별된 재생 목록에**&#x200B;대한 관심을 표현할 수 있습니다.
...
학습자 앱에서 모든 관리자는 Content Marketplace에 액세스할 수 있습니다. 책임자가 액세스 권한을 취소하면 학습자는 Content Marketplace 탭을 볼 수 없습니다.

책임자가 초대한 학습자는 콘텐츠 마켓플레이스를 탐색할 수 있습니다.

>[!NOTE]
>
>Content Marketplace는 Internet Explorer 11에서 지원되지 않습니다.

모든 필터 및 기타 옵션은 아래의 비디오에서 확인할 수 있습니다.

### 콘텐츠 미리 보기

강의를 미리 보고 각자의 학습 요구 사항에 맞는 강의인지 확인할 수 있습니다. **미리 보기** 버튼을 클릭하고 과정 미리 보기를 확인합니다. 미리 보기는 2분 간 사용할 수 있습니다.

![](assets/content-marketplace-learner.gif)
*Marketplace에서 콘텐츠 미리 보기*

## 콘텐츠 허브

Content Hub를 통해 관리자 및 SME(실무 전문가)는 학습자 앱에서 필수 재생 목록을 선정할 수 있습니다. 최종 후보 명단에 오르면 관리자는 구매 요청 양식을 다운로드하고 이를 Adobe 판매 담당자와 공유할 수 있습니다.

책임자는 SME에게 관심이 있는 플레이리스트를 관심 목록에 추가하라고 권유할 있습니다.

Content Hub는 모든 책임자가 학습자 역할로 사용할 수 있습니다. 책임자가 허용할 경우 SME는 구매 의사가 있는 플레이리스트를 관심 목록에 추가할 수 있습니다.
...
1. 라디오 버튼을 사용하여 모든 코스 또는 선택되지 않은 인스턴스가 있는 코스를 볼지 여부를 선택합니다. 학습자가 인스턴스를 완료하면 다른 인스턴스로 전환할 수 없습니다.

   ![](assets/radio-buttons.jpg)
   *모든 강좌 또는 선택하지 않은 인스턴스가 있는 강좌 보기*
...
1. 선택한 인스턴스를 적용하려면 **[!UICONTROL &#39;등록 업데이트&#39;]**&#x200B;를 클릭합니다. 등록 업데이트 옵션은 페이지 오른쪽 위에서 사용할 수 있습니다.
   ...
   새로 선택한 인스턴스가 등록됩니다. 학습자가 다른 LO의 일부인 강의 인스턴스에 등록되어 있고 유연한 학습 프로그램의 일부인 강의 인스턴스를 업데이트하면 경고 후 다른 학습 객체에서 자동으로 등록 취소됩니다.
...
게시물은 토론 탭에 즉시 나타납니다. 게시물을 최신 항목 또는 가장 오래된 항목 순으로 정렬하고 작성한 게시물을 삭제할 수 있습니다. 강의 등록을 취소하여도 모든 게시물을 볼 수 있으며 작성한 게시물을 삭제할 수 있습니다.
...
**게시됨** - 작성자가 강의 게시를 완료한 경우입니다. 이 상태인 경우 학습자는 강의에 등록할 수 있습니다.

**중단** 됨 - 작성자는 강의를 게시한 후 학습자용 강의 카탈로그에 강의가 표시되지 않도록 하려면 강의를 중단됨 상태로 이동할 수 있습니다.

**삭제됨** - 삭제된 상태의 강의는 Adobe Learning Manager 응용 프로그램에서 완전히 제거된 경우입니다. 강의는 오직 초안 또는 중단 상태일 때만 작성자가 삭제할 수 있습니다.
