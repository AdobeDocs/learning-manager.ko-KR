...
이 플랫폼에서 공유할 수 있는 다른 유형의 콘텐츠는 비디오, 오디오, 스크린샷, 텍스트, 질문 및 투표입니다. 또한 사용자는 **소셜 북마클릿에 공유**&#x200B;를 사용하여 동료와 온라인 학습을 공유할 수도 있습니다. 자세한 내용은 [소셜 학습에 공유](share-to-social.md)를 참조하세요.

**Adobe Learning Manager 데스크탑 응용 프로그램**&#x200B;의 도움말을 참조하여 콘텐츠를 보드에 게시할 수도 있습니다. 자세한 내용은 [데스크탑용 Adobe Learning Manager 앱](../adobe-learning-manager-app-for-desktop.md)을 참조하세요.
...
1. 게시할 콘텐츠 유형을 텍스트, 질문, 비디오, 오디오, 투표, 스크린샷 중에서 선택합니다. 기존 콘텐츠를 사용자 시스템 또는 Adobe Learning Manager 데스크탑 응용 프로그램의 갤러리에서 업로드할 수 있습니다.
   ...
   Adobe Learning Manager 데스크탑 앱을 사용해 비디오 또는 화면, 오디오를 레코딩하고 스크린샷을 찍습니다. 자세한 내용은 [Adobe Learning Manager 데스크탑 응용 프로그램](../adobe-learning-manager-app-for-desktop.md)을 참조하십시오.

   <!--![](assets/types-of-post-03.png)-->

1. 게시물과 관련된 보드 또는 스킬을 검색합니다. 보드가 없는 경우 **[!UICONTROL 새 보드 만들기]**&#x200B;를 클릭합니다.
...
1. 팝업 대화 상자에 세부 정보를 입력하고 보드 유형을 다음에서 선택합니다.
   ...
   * **제한** - 보드 소유자, 책임자 및 보드 중재자만 게시물을 만들 수 있습니다. 기타 사용자는 댓글/답변을 남기고, 업보트/다운보트를 클릭하는 등의 활동을 통해 참여할 수 있습니다.
   ...
   >
   >관리자, 작성자, 학습자, 관리자, 강사 등을 제외한 다른 모든 사용자는 사용자 그룹으로 비공개 게시판을 만들 수 없습니다&#x200B;**.**&#x200B;비공개 보드 생성 중에는 **사용자 그룹**&#x200B;의 섹션을 볼 수 없습니다.
...
1. 콘텐츠를 공유하려면 **[!UICONTROL 게시]**&#x200B;를 클릭합니다. 게시를 클릭하면 사용자에게 알림이 표시됩니다.
...
게시물이나 댓글 또는 답변 섹션에서 콘텐츠를 다운로드할 수 있습니다. 한 번에 1개의 파일만 다운로드할 수 있습니다.

모든 유형의 사용자(내부 또는 외부)가 콘텐츠를 다운로드할 수 있어야 합니다.

다운로드 버튼도 게시물이나 댓글 또는 답변에 대해 검색 결과에 표시될 수 있습니다.
...
여러 사용자 그룹이 비공개 보드에 추가되면 두 사용자 그룹의 모든 사용자가 비공개 보드에 액세스할 수 있습니다.
...
1. 게시물의 오른쪽 상단 모서리에서 축소된 메뉴 아이콘을 클릭하고 **[!UICONTROL 내 스토리에 추가]**&#x200B;를 클릭합니다.
...
게시물을 생성하는 동안 게시물과 관련된 보드가 없으면 [새 보드 만들기](social-learning-web-user.md#Creatingcontentasapost)를 클릭하십시오.  보드를 보고, 편집하고, 신고하고, URL을 복사하고, 즐겨찾는 보드 목록에 추가하려면 다음 단계를 따르십시오.
