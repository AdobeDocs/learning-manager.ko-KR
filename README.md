...
[Adobe 문서 콘텐츠 작가 안내서](https://experienceleague.adobe.com/docs/contributor/contributor-guide/introduction.html)를 참조하세요.

참가 방법은 참가 대상 및 참가할 변경 내용에 따라 다릅니다.

### 사소한 변경 사항

좋은 마음으로 작은 업데이트를 가져오는 경우 문서를 방문하고 문서의 GitHub 소스로 이동하는 문서에서 **편집** 링크를 클릭합니다. 그런 다음 GitHub UI를 사용하여 업데이트하십시오. 자세한 내용은 일반 [Adobe 문서 콘텐츠 작가 안내서](https://experienceleague.adobe.com/docs/contributor/contributor-guide/introduction.html)를 참조하세요.
